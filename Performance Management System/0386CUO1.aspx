<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CUO1.aspx.vb" Inherits="Performance_Management_System._0386CUO1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3)績效評核_可變薪酬評核表-僅適用於第三級作業職 Curing OP (Trimming OP/Repair OP/Bladder OP)</td>
                                        </em>
                    ...
                    <tr>
                        <td class="auto-style280">
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score2" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" Height="21px" style="text-align:center" TabIndex="2"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style130" rowspan="2"><em>&nbsp;5.Observation Skill, Detailed feedback to supervisors, Shift start/close meeting communication （觀察技巧，給主管的詳細反饋，輪班開始/結束會議溝通）<asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="score5" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284">3. Defective Rate/ Scrap Rate 不良率 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="score3" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                ...
                                <td class="auto-style303">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304">
                                                <asp:TextBox ID="score6" runat="server" AutoPostBack="True" CssClass="auto-style165" Width="70px" TabIndex="6"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    </em>
