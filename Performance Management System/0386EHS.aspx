<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386EHS.aspx.vb" Inherits="Performance_Management_System._0386EHS" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) EHS 績效評核_可變薪酬評核表-僅適用於第三級作業職 </td>
                                        </em>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                <tr style="background-color: #D9E1F2; text-align:center"> 
                                    ...
                                    <td class="auto-style339">1<strong>4%</strong></td>
                                </tr>
                            </table>
                            <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                <tr>
                                    ...
                                    <td class="auto-style133" rowspan="3">
                                        <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center;height:100%">
                                            <tr>
                                                <td class="auto-style122" rowspan="2"><br /><br /><br /><br /><br /><br /><br />Communication<br /><br /><br /><br /><br /><br /><br /></td>
                                    ...
                                    <td class="auto-style132"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</td>
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="10"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style346" rowspan="3">Work rate achievement</td>
                                    ...
                                    <td class="auto-style133" rowspan="5">
                                        <table class="auto-style341" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            <tr>
                                                <td class="auto-style122"><br /><br /><br /><br /><br /><br /><br /><br /><br />Material/Equipment Management<br /><br /><br /><br /><br /><br /><br /><br /><br /></td>
                                                <td class="auto-style122">Effective material usage/ Management / Methods 化學品/材料- 有效利用/管理</td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style132" rowspan="5"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</td>
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score11" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="11"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style346">Reporting of unsafe act/ unsafe condition near miss 報告不安全行為/不安全情況險些發生</td>
                                    <td class="auto-style345"><em>
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style346">Operation as per control limits/ Maintaining parameters 一級檢點/ 數據維持</td>
                                    <td class="auto-style345"><em>
                                        <table class="nav-justified">
                                            <tr>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                            <tr>
                                ...
                                <td class="auto-style314" style="background-color: #FFD966; text-align:center">10<strong>%</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="14"></asp:TextBox>
                                </td>
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style327">
                                                <asp:TextBox ID="score12" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align:center" TabIndex="12" Width="122px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="15"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style327">5%</td>
                                            <td class="auto-style327">
                                                <asp:TextBox ID="score13" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align:center" TabIndex="13" Width="122px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="dhead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="16"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:TextBox ID="score14" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="17"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
