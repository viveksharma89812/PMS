...
<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386QVO1.aspx.vb" Inherits="Performance_Management_System._0386QVO1" %>
    ...
    <div class="camera-container">
        ...
        <!-- Webcam Container -->
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) Visual Inspection/ DB Inspection 績效評核_可變薪酬評核表-僅適用於第三級作業職 外觀檢查員/測定人員</td>
                                        </em>
                                        ...
                                        <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style122" colspan="3">Year : <em>
                                                    ...
                                                    <em>&nbsp;</em><asp:CheckBox ID="q1" runat="server" CssClass="auto-style280" Text="Q1" AutoPostBack="True" ViewStateMode="Disabled" Visible="False" />
                                                    <em>&nbsp;</em><asp:CheckBox ID="q2" runat="server" CssClass="auto-style280" Text="Q2" AutoPostBack="True" ViewStateMode="Disabled" Visible="False" />
                                                    <em>&nbsp;</em><asp:CheckBox ID="q3" runat="server" CssClass="auto-style280" Text="Q3" AutoPostBack="True" ViewStateMode="Disabled" Visible="False" />
                                                    <em>&nbsp;</em><asp:CheckBox ID="q4" runat="server" CssClass="auto-style280" Text="Q4" AutoPostBack="True" ViewStateMode="Disabled" Visible="False" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style284">
                                        <table class="auto-style326">
                                            <tr>
                                                ...
                                                <td class="auto-style122">Outflow Control/Customer Complaint/SOP 不良流出/客訴/SOP<em> <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="score2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <tr>
                    <td class="auto-style280">
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center;font-size:large;height:13%">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style328">
                                    <asp:TextBox ID="sldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                </td>
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score6" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style327">3</td>
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score7" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td class="auto-style291">3. Section Head/ Section Supervisior</td>
                                <td class="auto-style138">
                                ...
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score8" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                ...
                <table border="1" class="auto-style169"  style="width:100%; border-collapse: collapse; text-align:center;font-size:x-large">
                    <tr>
