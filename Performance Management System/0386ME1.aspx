<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386ME1.aspx.vb" Inherits="Performance_Management_System._0386ME1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3)表 Mechanical equipment engineer 績效評核_可變薪酬評核表-僅適用於第三級作業職</td>
                                        </em>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center;font-size:large">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130">3.Environment 5S (環境5S)<span class="auto-style289"> <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="score3" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style284">
                                        <table class="nav-justified" style="width:100%; border-collapse: collapse; text-align:center">
                                            <tr>
                                                <td class="auto-style122">2.Equipment maintenance plan achievement rate 設備保養計畫達成率</td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">51%</span></td>
                                                <td class="auto-style131">
                                    ...
                                    <td class="auto-style130"><em>4.Matters assigned by superiors上級交辦事項 <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="score4" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style129">
                                        <em>
                                        <table class="nav-justified">
                        ...
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center;font-size:large">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="8"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score5" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center" TabIndex="5"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="9"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="dhead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="10"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:TextBox ID="score7" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True" TabIndex="7"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
