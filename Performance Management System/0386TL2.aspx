...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386TL2.aspx.vb" Inherits="Performance_Management_System._0386TL2" %>
           ...
           <div id="printableContent">
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2) Spraying Leader 領導/主管/一般員工績效考核表 僅適用於 第二級  </td>
                                        </em>
               ...
               <table id="2" border="1" class="auto-style20" style="width:100%; border-collapse: collapse;">
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2" rowspan="2">
                                        <table class="auto-style328">
                                            <tr>
                                                <td class="auto-style325" rowspan="2"><br /><br />2. Scrap rate <br />報廢率<br /><br /></td>
                ...
                <tr>
                    <td class="auto-style280">
                        <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse; font-size:large;height:10%">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138" rowspan="2">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" Height="45px"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score12" runat="server" CssClass="auto-style165" Width="244px"  style="text-align: center" AutoPostBack="True"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                ...
                <table id="tb1" runat="server" border="1" class="auto-style20"  style="width:100%;  border-collapse: collapse;height:10%;font-size:large">
                    ...
                    <tr>
                        <td class="auto-style329" style="background-color:#eea236" rowspan="2"><strong>Remarks 評論</strong></td>
