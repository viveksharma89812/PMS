<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386TL2.aspx.vb" Inherits="Performance_Management_System._0386TL2" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表TB -Spraying Leader噴粉主管</td>
                                        </em>
                                    ...
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">3%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score8" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">10%</td>
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score4" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
