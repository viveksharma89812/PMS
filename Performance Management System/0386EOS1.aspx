...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386EOS1.aspx.vb" Inherits="Performance_Management_System._0386EOS1" %>
...
<div id="outerimgdiv" style="position:fixed;" runat="server">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2) Office staff 領導/主管/一般員工績效考核表僅適用於 第二級      </td>
                                        </em>
    ...
    <table id="2" border="1" class="auto-style20" style="width:100%; border-collapse: collapse;">
                        ...
                        <td class="auto-style280">
                               <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse;">
                                ...
                                <tr >
                                       ...
                                       <td class="auto-style324" rowspan="2" colspan="2"><br />2. Document and SAP control 文件和SAP管控<br /> 報廢率/不良率<br /><em>
                                    ...
                                    <td class="auto-style130" rowspan="1">5<span class="auto-style289">.Observation Skill,Detailed feedback to supervisors,Shift start/close Meeting Communication（觀察技巧，給主管的詳細反饋，輪班開始/結束會議溝通）
                                        <br />
                                       <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="score5" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="1">6.Proposals to improve (提案改善)<em>
                    ...
                    <td class="auto-style280">
                          ...
                          <td class="auto-style313" style="background-color: #FFD966; text-align:center">
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score8" runat="server"  style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="8"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score9" runat="server"   style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="9"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
              ...
              <table id="Table1" runat="server" border="1" class="auto-style20">
              
                            <tr>
                                <td class="text-center" style="width:950px; background-color:#8EA9DB"><strong> &nbsp; </strong></td>
