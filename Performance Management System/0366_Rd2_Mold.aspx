<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0366_Rd2_Mold.aspx.vb" Inherits="Performance_Management_System.WebForm25" %>
...
<center><asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="882px" BackColor="#ffffff">
        <table class="auto-style3" border="1">
            <tr>
                <td colspan="6" style=" font-style: oblique; font-weight:bold" onclick="return false"><asp:CheckBox ID="c1" runat="server"></asp:CheckBox> Training / <asp:CheckBox ID="c2" runat="server"></asp:CheckBox> Probation Period Review Form (For RD2 Mold Operator)訓練期/試用期評核表(作業人員)</td>
            </tr>
            <tr>
        ...
        <tr>
            ...
            <td class="auto-style23">
                20%</td>
            <td colspan="2" style="text-align:left">2.Mold cleaning rate 洗模達成率</td>
        </tr>
        <tr>
            <td colspan="3" class="auto-style36">Actual Present Days</td>
            <td class="auto-style37">
                <asp:Label ID="actpresent" runat="server" Text="Label"></asp:Label>
            </td>
            <td class="auto-style38" style="text-align:left">* Excellent=20 Point</td>
            ...
            <tr>
                ...
                <td colspan="2" style="text-align:left">3.(previous)Customer complaints rate 上工程客訴率</td>
            </tr>
        <tr>
