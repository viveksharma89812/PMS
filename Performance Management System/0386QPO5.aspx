<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386QPO5.aspx.vb" Inherits="Performance_Management_System._0386QPO5" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) PDI Shift Supervisor 績效評核_可變薪酬評核表-僅適用於第三級作業職</td>
                                        </em>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                <tr style="background-color: #D9E1F2; text-align:center">
                                    ...
                                    <td class="auto-style132">18<strong>%</strong></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="auto-style130">7. Environment 5S /Safety (環境5S/安全)</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style284">
                                        2.Work Achievement Rate 達成率</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                    ...
                                    <td class="auto-style130">8.Team Management 團隊管理</td>
                                    <td class="auto-style129">
                                        <em>
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style284">3. Shop floor daily management board update &amp; timely recording of daily machine checklists 車間日常管理板更新並及時記錄每日機器檢查表</td>
                                    ...
                                    <td class="auto-style130">9.Employee Behaviour (員工行為)</td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</span></td>
                                ...
                                <tr>
                                    <td class="auto-style284">4. Daily Rejection cleareance &amp; data monitoring of daily rejection record 每日拒收清關及每日拒收記錄數據監控</td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">10%</td>
                                    ...
                                    <td class="auto-style130">10.Problem solving skills (解決問題的能力)</td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</span></td>
                                ...
                                <tr>
                                    <td class="auto-style284">5.Customer Complaints 顾客抱怨 </td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                    ...
                                    <td class="auto-style130" rowspan="2">11.Self Initiative approach (自我主動的方法)</td>
                                ...
                                <tr>
                                    <td class="auto-style284">6.Continuous Improvement (Monthly Kaizen submissions)持續改進（每月改善提交）</td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">10%</td>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                            <tr>
                                ...
                                <td class="auto-style314" style="background-color: #FFD966; text-align:center"><strong>6%</strong></td>
                            </tr>
                            <tr>
