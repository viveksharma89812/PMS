<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386M3.aspx.vb" Inherits="Performance_Management_System._0386M3" %>
...
<script type="text/javascript">
    function checkLength() {
        var maxLength = 250;
        var text = document.getElementById('<%= remark.ClientID %>').value;
        
        if (text.length > maxLength) {
            alert("Maximum 250 characters allowed.");
            document.getElementById('<%= remark.ClientID %>').value = text.substring(0, maxLength);
            return false;
        }
        return true;
    }
        ...
        <!-- Webcam Container -->
          ...
          <div id="printableContent">
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                <table id="1" border="1" class="auto-style21"  style="width:100%;  border-collapse: collapse; " >
                    <tr>
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified"  border="1" style="border-collapse: collapse;">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form for leader/Supervisor/Staff (Only for Level 2) Mixing Leader 領導/主管/一般員工績效考核表 僅適用於 第二級</td>
                                        </em>
                ...
                <table id="2" class="auto-style20"   style="width:100%;border-collapse: collapse; ">
                    <tr>
                        <td class="auto-style280"  style="width:100%">
                            <table class="nav-justified"  style="width:100%;border-collapse: collapse; height:25%;">
                                <tr>
                                    <td class="auto-style122">
                                        <table class="nav-justified"  border="1" style="width:100%;border-collapse: collapse; height:30%;">
                                            <tr>
                    ...
                    <tr>
                        <td class="auto-style284" style="text-align:center"><strong>Assessment Parameters</strong></td>
                    </tr>
                    <em>
                    <tr>
                        <td class="auto-style280">
                            <table class="nav-justified"  border="1" style="border-collapse: collapse;">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style311">5<span class="auto-style289">. Environment 5S (環境5S) <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="score7" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                    <td class="auto-style310">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style322">6<span class="auto-style289">. Work assigned by Leader 上級交代事項 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="score8" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                    <td class="auto-style321">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2" rowspan="2">
                                        <table class="nav-justified" border="1"  style="border-collapse: collapse; width:100%;height:100%">
                                            <tr>
                                                <td class="auto-style324" rowspan="2">2.Scrap rate 報廢率</td>
                                                <td class="auto-style122">Raw materials (Chemical, Cutting rubber) 原材料 (藥品、生膠) <em>
                                            ...
                                            <tr>
                                                <td class="auto-style122">Mixer(Non Product, Final) 膠料(未促、加促) <em>
                                    ...
                                    <td class="auto-style130">7<span class="auto-style289">.Level-1 maintenance checkpoints check
                                        <br />
                                        一級保養 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="score9" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="2">8.Observation Skill, Detailed feedback to supervisors, Shift start/close meeting communication （觀察技巧，給主管的詳細反饋，輪班開始/結束會議溝通） <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="score10" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">4<span class="auto-style289">.Defective rate 不良率 
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="score6" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                    ...
                                    <td class="auto-style130">9.Proposals to improve (提案改善)&nbsp;
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="score11" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                ...
                <em></em><em></em>
                  <tr><td border="1"><h4><u> Adhere to the above criteria based on your employee's supervised performance.  根據您員工的監督績效遵守上述標準</u></h4></td></tr>
                    </em></em></em>
            
                <tr>
                    <td class="auto-style280" style="text-align:center">
                        <table class="nav-justified" border="1" style="width:100%;border-collapse: collapse; height:15%">
                            ...
                            <tr style="text-align:center">
                                <td class="auto-style313" style="background-color: #FFD966;border-collapse: collapse;text-align:center;">
                                    <table>
                                        <tr style="text-align:center">
                                            <td style="background-color: #FFD966; text-align:center">(0% but can change all)</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style137">1. Supervisor </td>
                                <td class="auto-style325"  style="text-align:center">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" Height="25px" TabIndex="13" MaxLength="25" style="text-align: center"></asp:TextBox>
                                </td>
                                <td class="auto-style303"  style="text-align:center">
                                    <em>
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style293"  style="text-align:center">4%</td>
                                            <td class="auto-style304"  style="text-align:center"><em>
                                                <asp:TextBox ID="score12" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="12" Width="70px"></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138"  style="text-align:center">
                                    <asp:TextBox ID="shead" runat="server" style="text-align: center" CssClass="auto-style165" Width="244px" TabIndex="14"></asp:TextBox>
                                </td>
                                <td class="auto-style122"  style="text-align:center">
                                    <asp:TextBox ID="score13" runat="server" style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="13"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style291" >3. Department Head</td>
                                <td class="auto-style138"  style="text-align:center">
                                    <asp:TextBox ID="dhead" runat="server" style="text-align: center" CssClass="auto-style165" Width="244px" TabIndex="15"></asp:TextBox>
                                </td>
                                <td class="auto-style122" style="text-align:center">
                                    <asp:TextBox ID="score14" runat="server" style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="14"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                 ...
                 <table id="Table1" runat="server" border="1" class="auto-style20" style="width:100%;">
              
                            <tr  style="width:100%">
                                <td class="text-center" style="width:100%; border-collapse: collapse; background-color:#8EA9DB;"><strong> &nbsp; </strong></td>
                               
                            </tr>
                        </table>
                <table id="tb1" runat="server" border="1" class="auto-style20"  style="width:100%; border-collapse: collapse;height:10%;">
                            <tr>
                                <td class="text-center" style="width:30%; font-size:large"><strong>Recommendation &amp; Summaries the overall performance and progress 建議和總結該員整體表現</strong></td>
                                <td class="auto-style83"  style="width:70%; ">
  <asp:TextBox ID="remark" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
    CssClass="form-control" Height="100%" style="width:100%;font-size:x-large;" TextMode="MultiLine" TabIndex="16"
    onkeyup="checkLength();"></asp:TextBox>                                </td>
                            </tr>
                        </table>
                        <table border="1" class="auto-style169" style="width:100%; border-collapse: collapse; height:25%;">
                            <tr>
                                <td class="auto-style282" style="background-color:#eea236;text-align:center" rowspan="2"><strong>Remarks 評論</strong></td>
                                <td class="auto-style334" rowspan="2" style="background-color:#eea236;text-align:center"><strong>Status of Review Period</strong></td>
                                <td class="auto-style173" colspan="3" style="background-color:#eea236;text-align:center"><strong>
                            ...
                            <tr>
                                <td class="auto-style173" colspan="3" style="background-color:#eea236;text-align:center"><strong>Approvals 批准</strong></td>
                            </tr>
                            <em>
                            <tr style="font-size:large">
                                <td class="auto-style172" rowspan="3" style="text-align:left; font-size:large"><span class="auto-style280">Performance status definition :考核結果說明 </span>
                                ...
                                <td class="auto-style175" style="background-color:#eea236;text-align:center"><strong>Total Score<br /> &nbsp;總得分<br /> &nbsp;100%</strong></td>
                                <td class="auto-style180"  style="text-align:center"><span class="auto-style280"><strong>Department Head </strong></span><strong>
                                    <br class="auto-style280" />
                                    </strong><span class="auto-style280"><strong>部門主管</strong></span></td>
                                <td class="auto-style281"  style="text-align:center"><strong>Section Head<br /> &nbsp;課長</strong></td>
                                <td class="auto-style180"  style="text-align:center"><span class="auto-style280"><strong>Employee Signature</strong></span><strong><br class="auto-style280" /> </strong><span class="auto-style280"><strong>員工簽名</strong></span></td>
                            </tr>
                            <tr>
                                <td class="auto-style175" style="font-size:small;text-align:center">
                                    <asp:Label ID="totmarks" runat="server" Text="Label"></asp:Label>
                                </td>
                                <td class="auto-style178" style="text-align:center">
...
<label id="lblEmpDate" runat="server"></label>
                            ...
                            <tr>
                                <td class="auto-style173" colspan="4" style="font-size:small;text-align:center">&nbsp;<asp:Label ID="Time" runat="server" Text="Label"></asp:Label>
                                </td>
                            </tr>
                        </table>
    ...
    <div style="text-align: right;">A4/A3 No. 0399-1</div>
           ...
           <center>
                            ...
                            <span class="auto-style184"><%--<asp:Button ID="Button2" runat="server" CssClass="auto-style102" Height="43px" Text="Export To PDF" />--%>&nbsp;<asp:Button ID="update" runat="server" cssclass="btn btn-primary" OnClick="update_Click" style="font-family: call; font-size: small;" Text="Update" ValidationGroup="insert" />
