<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Employee Details.aspx.vb" Inherits="Performance_Management_System.WebForm13" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:HiddenField ID="hfScrollPosition" Value="0" runat="server" />
         ...
         <div id="dvScroll"  class="divcss" onscroll="setScrollPosition(this.scrollTop);" style=" overflow: auto;
          height:500px;
            width: auto;
            ">
        <asp:GridView ID="GridView1" runat="server" Width="32px" AutoGenerateColumns="False" DataKeyNames="EmployeeCode" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
        <Columns>
  ...
  CommandArgument='<%# Bind("EmployeeCode") %>' OnClick="Display"  CommandName="Download" Text='<%# Eval("EmployeeCode") + " - " + Eval("EmployeeName") %> ' CssClass="btn btn-link"></asp:LinkButton>
                </ItemTemplate>
                <ControlStyle  />
                <HeaderStyle  Wrap="False" />
             ...
             <asp:TemplateField HeaderText="Review Form">
                <ItemTemplate>
                     <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                                    ...
                                    <ContentTemplate>
<asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Bind("EmployeeCode") %>' OnClientClick="SetTarget()"  CommandName="Form" Text="Review Form" CssClass="btn btn-link"  ></asp:LinkButton>
                                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("EmployeeCode") %>' visible="false"></asp:Label>
