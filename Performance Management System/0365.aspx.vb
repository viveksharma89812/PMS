...
Public Class WebForm9
    ...
    Protected Sub insert_Click(sender As Object, e As EventArgs) Handles insert.Click
        ...
        End If
        If plheadsign.Checked = True Then
            strsql = "update" + " " + tot + " " + "Set Score1='" & scor1.Text & "',Score2='" & scor2.Text & "',Score3='" & scor3.Text & "',Score4='" & scor4.Text & "',Score5='" & scor5.Text & "',Score6='" & scor6.Text & "',TotalMarks='" & totmarks.InnerText & "',Remark='" & remark.Text & "',Status='" & stat & "',Form_Status='DONE',Form_ID='2',Plhead_Accept = '" & plheadaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
        ...
        End If
        If deptsign.Checked = True Then
            strsql = "update" + " " + tot + " " + "Set Score1='" & scor1.Text & "',Score2='" & scor2.Text & "',Score3='" & scor3.Text & "',Score4='" & scor4.Text & "',Score5='" & scor5.Text & "',Score6='" & scor6.Text & "',TotalMarks='" & totmarks.InnerText & "',Remark='" & remark.Text & "',Status='" & stat & "',Form_Status='PENDING',Form_ID='2',Dept_Accept='" & deptaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
            If sqlexe(constr, strsql) Then
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Messagebox", "alert('Inserted successfully');window.close()", True)
                ' clear()
            End If
        End If
        If sectsign.Checked = True Then
            strsql = "update" + " " + tot + " " + "Set Score1='" & scor1.Text & "',Score2='" & scor2.Text & "',Score3='" & scor3.Text & "',Score4='" & scor4.Text & "',Score5='" & scor5.Text & "',Score6='" & scor6.Text & "',TotalMarks='" & totmarks.InnerText & "',Remark='" & remark.Text & "',Status='" & stat & "',Form_Status='PENDING',Form_ID='2',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
            If sqlexe(constr, strsql) Then
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Messagebox", "alert('Inserted successfully');window.close()", True)
                ' clear()
            End If
        ...
        If plheadsign.Checked = True And deptsign.Checked = True And sectsign.Checked = True Then
            strsql = "update" + " " + tot + " " + "Set Score1='" & scor1.Text & "',Score2='" & scor2.Text & "',Score3='" & scor3.Text & "',Score4='" & scor4.Text & "',Score5='" & scor5.Text & "',Score6='" & scor6.Text & "',TotalMarks='" & totmarks.InnerText & "',Remark='" & remark.Text & "',Status='" & stat & "',Form_Status='DONE',Form_ID='2',Plhead_Accept = '" & plheadaccept & "',Dept_Accept='" & deptaccept & "',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
            If sqlexe(constr, strsql) Then
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Messagebox", "alert('Inserted successfully');window.close()", True)
                ' clear()
            End If
