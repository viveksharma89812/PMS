...
'                    score10.SelectedValue = Convert.ToString(ds.Tables(0).Rows(0)("Score10"))
...
'                    score13.Text = Convert.ToString(ds.Tables(0).Rows(0)("Score13"))
...
'            End If
'        If score2.Text <> "" And score2.Text <= 20 Then
...
'                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Messagebox", "alert('Your fill number is more the system % please according to Max fill.       你填寫的百分比高過制度，請重新確認與填寫');window.close()", True)
'            End If
'        If score5.Text <> "" And score5.Text <= 2 Then
...
'        If score6.Text <> "" And score6.Text <= 2 Then
...
'                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Messagebox", "alert('Your fill number is more the system % please according to Max fill.       你填寫的百分比高過制度，請重新確認與填寫');window.close()", True)
'            End If
'        If score7.Text <> "" And score7.Text <= 4 Then
...
'                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Messagebox", "alert('Your fill number is more the system % please according to Max fill.       你填寫的百分比高過制度，請重新確認與填寫');window.close()", True)
'            End If
'        If score9.Text <> "" And score9.Text <= 2 Then
...
'        Tot9 = Double.Parse(score10.SelectedIndex)

'        If score10.SelectedIndex = "0" Then
'            Tot9 = "4"
'        ElseIf score10.SelectedIndex = "1" Then
'            Tot9 = "3"
'        ElseIf score10.SelectedIndex = "2" Then
'            Tot9 = "2"
'        ElseIf score10.SelectedIndex = "3" Then
'            Tot9 = "1"
'        Else
...
'            End If
'        For i As Integer = 0 To score10.Items.Count - 1
'            score10.Items(i).Attributes.Add("onclick", "MutExChkList(this)")
...
'        '        Tot8 = Double.Parse(score9.Text)
'        '    End If
'        If score13.Text <> "" Then
'            Tot12 = Double.Parse(score13.Text)
'        End If
'        '    'If score9.Text <> "" Then
'        '    Tot8 = Double.Parse(score9.Text)
'        'End If
...
'        If score1.Text <> "" And score2.Text <> "" And score3.Text <> "" And score4.Text <> "" And score5.Text <> "" And score6.Text <> "" And score7.Text <> "" And score8.Text <> "" And score9.Text <> "" And score10.SelectedValue <> "" And score11.SelectedValue <> "" And score12.SelectedValue <> "" And score13.Text <> "" Then
...
'                End If
'                If ch2.Checked = True Then
'                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',Score6='" & score6.Text & "',Score7='" & score7.Text & "',Score8='" & score8.Text & "',Score9='" & score9.Text & "', Score10='" & score10.SelectedValue & "' , Score11='" & score11.SelectedValue & "', Score12='" & score12.SelectedValue & "',Score13='" & score13.Text & "',  TotalMarks='" & totmarks.Text & "',Status='" & status & "',Form_Status='PENDING',Form_ID='32',Sect_Accept='" & sectaccept & "',Ldr ='" & ldr.Text & "' , Shead = '" & shead.Text & "', Dhead = '" & dhead.Text & "' , Famnt = '" & famnt.Text & "' , Amnt1 = '" & amnt2.Text & "' ,Empn = '" & empnaccept & "', Ldrn = '" & ldrnaccept & "', Sheadn = '" & sheadnaccept & "' , Dheadn = '" & dheadnaccept & "' , Empd = '" & empdaccept & "' , Ldrd = '" & ldrdaccept & "', Sheadd = '" & sheaddaccept & "' , Dheadd = '" & dheaddaccept & "'  , Remark2 = '" & remark2.Text & "' , Remark3 = '" & remark3.Text & "' , Remark4 = '" & remark4.Text & "' , Emp_Accept1 = '" & empsignaccept & "' , Emp_Accept2 = '" & ldrsignaccept & "', Emp_Accept3 = '" & sheadsignaccept & "' ,Emp_Accept4 = '" & dheadsignaccept & "' , Sameas = '" & sameasaccept & "', Sincrease ='" & sincreaseaccept & "' , Sdecrease = '" & sdecreaseaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
...
'                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',Score6='" & score6.Text & "',Score7='" & score7.Text & "',Score8='" & score8.Text & "',Score9='" & score9.Text & "', Score10='" & score10.SelectedValue & "' , Score11='" & score11.SelectedValue & "', Score12='" & score12.SelectedValue & "',Score13='" & score13.Text & "',  TotalMarks='" & totmarks.Text & "',Status='" & status & "',Form_Status='DONE',Form_ID='32',Dept_Accept='" & deptaccept & "',Sect_Accept='" & sectaccept & "',Ldr ='" & ldr.Text & "' , Shead = '" & shead.Text & "', Dhead = '" & dhead.Text & "' , Famnt = '" & famnt.Text & "' , Amnt1 = '" & amnt2.Text & "' ,Empn = '" & empnaccept & "', Ldrn = '" & ldrnaccept & "', Sheadn = '" & sheadnaccept & "' , Dheadn = '" & dheadnaccept & "' , Empd = '" & empdaccept & "' , Ldrd = '" & ldrdaccept & "', Sheadd = '" & sheaddaccept & "' , Dheadd = '" & dheaddaccept & "'  , Remark2 = '" & remark2.Text & "' , Remark3 = '" & remark3.Text & "' , Remark4 = '" & remark4.Text & "' , Emp_Accept1 = '" & empsignaccept & "' , Emp_Accept2 = '" & ldrsignaccept & "', Emp_Accept3 = '" & sheadsignaccept & "' ,Emp_Accept4 = '" & dheadsignaccept & "' , Sameas = '" & sameasaccept & "', Sincrease ='" & sincreaseaccept & "' , Sdecrease = '" & sdecreaseaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
...
Public Class _0386TA1
    ...
    Public Sub up()
        ...
        Dim s13 As String = score13.Text
        Dim deptaccept As String = ""
        Dim sectaccept As String = ""
        If ch1.Checked = True Then
            deptaccept = "Done"
        ...
        End If
        If ch1.Checked = True Then
            strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',Score6='" & score6.Text & "',Score7='" & score7.Text & "',Score8='" & score8.Text & "',Score9='" & score9.Text & "', Score10='" & score10.SelectedValue & "' , Score11='" & score11.SelectedValue & "', Score12='" & score12.SelectedValue & "',Score13='" & score13.Text & "',  TotalMarks='" & totmarks.Text & "',Status='" & status & "',Form_Status='PENDING',Form_ID='32',Dept_Accept='" & deptaccept & "',Ldr ='" & ldr.Text & "' , Shead = '" & shead.Text & "', Dhead = '" & dhead.Text & "' , Famnt = '" & famnt.Text & "' , Amnt1 = '" & amnt2.Text & "' ,Empn = '" & empnaccept & "', Ldrn = '" & ldrnaccept & "', Sheadn = '" & sheadnaccept & "' , Dheadn = '" & dheadnaccept & "' , Empd = '" & empdaccept & "' , Ldrd = '" & ldrdaccept & "', Sheadd = '" & sheaddaccept & "' , Dheadd = '" & dheaddaccept & "'  , Remark2 = '" & remark2.Text & "' , Remark3 = '" & remark3.Text & "' , Remark4 = '" & remark4.Text & "' , Emp_Accept1 = '" & empsignaccept & "' , Emp_Accept2 = '" & ldrsignaccept & "', Emp_Accept3 = '" & sheadsignaccept & "' ,Emp_Accept4 = '" & dheadsignaccept & "' , Sameas = '" & sameasaccept & "', Sincrease ='" & sincreaseaccept & "' , Sdecrease = '" & sdecreaseaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
    ...
    Private Sub result()
        ...
        If Gtot >= 101 Then
            ...
            score13.ForeColor = Color.Red
            score13.BackColor = Color.Yellow
        ...
        Else
            Gtot = Tot + Tot1 + Tot2 + Tot3 + Tot4 + Tot5 + Tot6 + Tot7 + Tot8 + Tot9 + Tot10 + Tot11 + Tot12
            score13.BackColor = Color.White
            score13.ForeColor = Color.Black
            If score1.Text <> "" And score2.Text <> "" And score3.Text <> "" And score4.Text <> "" And score5.Text <> "" And score6.Text <> "" And score7.Text <> "" And score8.Text <> "" And score9.Text <> "" And score10.SelectedValue <> "" And score11.SelectedValue <> "" And score12.SelectedValue <> "" And score13.Text <> "" Then
                totmarks.Text = Gtot.ToString
            End If
        End If
