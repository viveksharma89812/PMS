<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Tax_New.aspx.vb" Inherits="Performance_Management_System.Tax_New" %>
...
<u style="color:red"><span style="color:red; "> Taxation  </span></u> <br /> 領導/主管/員工績效考核表（僅適用於二級） 稅務</td>
                                        </em>
                            ...
                            <tr style="background-color: #D9E1F2; text-align:center">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                        2 .TDS Working Monthly and Quartely return TDS 工作月報表及季報表</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                      3 GST notice and assesment compliance  GST 通知和評估合規性</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                       4. Interst on Borrowing/Deposit 借貸/存款利息</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                     ...
                                     <td class="auto-style284" rowspan="2" >
                                      8.Problem solving skills 解決問題的能力</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                      5.GST Monthly Return & GST Annual Return GST 每月申報表及 GST 年度申報表</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                     ...
                                     <td class="auto-style284" rowspan="2" >
                                       09.Self Initiative approach   自我主動的方法</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
