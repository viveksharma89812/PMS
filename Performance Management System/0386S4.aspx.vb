...
Public Class _0386S4
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If dt1 IsNot Nothing AndAlso dt1.Rows.Count > 0 Then
                ...
                otlea.InnerText = Convert.ToString(dt1.Rows(0)("Otherleaves"))
    ...
    Public Sub up()
        ...
        If ch1.Checked = True Then
            result()
            strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',  TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='DONE',Form_ID='75',Dept_Accept='" & deptaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
    ...
    Private Sub result()
        ...
        Else
            Gtot = Tot + Tot1 + Tot2 + Tot3 + Tot4 + Tot5
            If score1.Text <> "" And score2.Text <> "" And score3.Text <> "" And score4.Text <> "" And score5.Text <> "" And scor.InnerText <> "" Then
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles insert.Click
        ...
        Try
            ...
            If ch2.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='PENDING',Form_ID='75',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
                If sqlexe(constr, strsql) Then

                End If
            End If
            If ch1.Checked = True And ch2.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='DONE',Form_ID='75',Dept_Accept='" & deptaccept & "',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
                If sqlexe(constr, strsql) Then
