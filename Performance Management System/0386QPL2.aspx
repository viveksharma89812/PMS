                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表 PDI Leader 出貨檢主管</td>
                                        </em>
                    ...
                    <tr>
                        <td class="auto-style280">
                            <table class="nav-justified">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2">1. Attendance 出勤率 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="TextBox1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style284">Personal 個人 <em>
                                    ...
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="TextBox31" runat="server" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                                </em>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style130" rowspan="2">5. Environment 5S /Safety (環境5S/安全)<span class="auto-style289"> <em>
                                ...
                                <tr>
                                    <td class="auto-style284">Shift 班別 <em>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">
                                        <table class="auto-style326">
                                            <tr>
                                                ...
                                                <td class="auto-style122">Outflow Control/Customer Complaint 不良流出/客訴<em><asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="TextBox1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style130" rowspan="3">6. Employee Behaviour and Team Work 員工行為與團隊合作<em><asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="TextBox1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2"><em>
                                        <table class="auto-style326">
                                            <tr>
                                                <td class="auto-style325">3.Improvement</td>
                                                <td class="auto-style122">Continuous learning/ improvements in the existing process 持續學習/提案改善<em><asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="TextBox1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="TextBox32" runat="server" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">4<em><span class="auto-style289">.Work Achievement Rate 達成率<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="TextBox1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></em></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                ...
                <tr>
                    <td class="auto-style280">
                        <table class="nav-justified">
                            ...
                            <tr>
                                <td class="auto-style291">2. Section Head/ Section&nbsp; Supervisor</td>
                                <td class="auto-style138">
