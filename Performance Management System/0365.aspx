<%@ Page Title="" Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0365.aspx.vb" Inherits="Performance_Management_System.WebForm9" %>
           ...
           <table class="auto-style20" border="1" style="width:915px;"  >
            ...
            <table id="3" border="1" class="auto-style114" style="width:915px;" >
                <tr>
                  ...
                  <tr>
                    <td rowspan="5" class="auto-style117" style="text-align:left; font-size:small">*Performance result definition: 考核結果說明 <br />
1.Pass: 適任<br />
...
延長期間共有三個月可進行改善</td>  
                ...
                <tr>
                    <td runat="server" class="auto-style116" colspan="5">
