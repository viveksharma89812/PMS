...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386TL1.aspx.vb" Inherits="Performance_Management_System._0386TL1" %>
...
<div id="outerimgdiv" style="position:fixed;" runat="server">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)  Building Leader  領導/主管/一般員工績效考核表僅適用於 第二級 </td>
                                        </em>
    ...
    <table id="2" border="1" class="auto-style20" style="width:100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td class="auto-style280">
                           <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse;font-size:large;height:15%">
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score1" runat="server"  AutoPostBack="True"  CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score7" runat="server"  AutoPostBack="True"  CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style321">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score2" runat="server"  AutoPostBack="True"  CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">2%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score8" runat="server"  AutoPostBack="True"  CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2" rowspan="2">
                                        <table class="auto-style328">
                                            <tr>
                                                <td class="auto-style325" rowspan="2"><br /><br />2. Scrap rate 報廢率<br /><br /></td>
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score3" runat="server"  AutoPostBack="True"  CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style326">
                                                    <asp:TextBox ID="score9"  AutoPostBack="True"  runat="server" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score5"  AutoPostBack="True"  runat="server" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score6"  AutoPostBack="True"  runat="server" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                           ...
                           <td class="auto-style313" style="background-color: #FFD966; text-align:center">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138" rowspan="2">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" Height="45px" AutoPostBack="True"></asp:TextBox>
                                </td>
                                <td class="auto-style303" rowspan="2">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304">
                                                <asp:TextBox ID="score11" runat="server" AutoPostBack="True" CssClass="auto-style165" TabIndex="8" Width="70px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score12" runat="server" AutoPostBack="True" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                ...
                <table id="tb1" runat="server" border="1" class="auto-style20"  style="width:100%;  border-collapse: collapse;height:10%;font-size:large">
                    <tr>
                        ...
                        <td class="auto-style83">
                            <asp:TextBox ID="remark" runat="server" BackColor="White" BorderColor="White"  AutoPostBack="True"  BorderStyle="None" cssclass="form-control" Height="70px" style="width:100%;font-size:x-large;height:100%"  TabIndex="16" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                </td>
                    ...
                    <tr>
                        <td class="auto-style332" style="background-color:#eea236" rowspan="2"><strong>Remarks 評論</strong></td>
                        <td class="auto-style175" rowspan="3" style="background-color:#eea236"><strong>Total Score<br /> &nbsp;總得分<br /> &nbsp;100%</strong></td>
                        <td class="auto-style333" colspan="3" style="background-color:#eea236"><strong>
