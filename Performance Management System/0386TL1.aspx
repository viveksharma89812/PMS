<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386TL1.aspx.vb" Inherits="Performance_Management_System._0386TL1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表TB -Building Leader 成型主管</td>
                                        </em>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="2">6. Near miss, accident, unsafe condition (nos) (未遂事件、事故、不安全狀況（否）)<span class="auto-style289"><em><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="score8" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="2">8.Proposals to improve (提案改善)</td>
                                    <td class="auto-style129" rowspan="2"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">2%</span></td>
                                                <td class="auto-style326">
                                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:CheckBoxList ID="score13" runat="server" RepeatDirection="Horizontal" Width="188px" AutoPostBack="True">
                                        <asp:ListItem Value="4">4%</asp:ListItem>
                                        <asp:ListItem Value="3">3%</asp:ListItem>
                                        <asp:ListItem Value="2">2%</asp:ListItem>
                                        <asp:ListItem Value="1">1%</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score14" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
