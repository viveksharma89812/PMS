<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CST1.aspx.vb" Inherits="Performance_Management_System._0386CST1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse;">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)  Office Staff <br /> 領導/主管/一般員工績效考核表 僅適用於 第二級     </td>
                                        </em>
                                        <td class="auto-style323">
                                            <asp:CheckBox ID="CheckBox1" runat="server" Font-Size="Medium" Text="Supervisior / Leader / Staff" Checked="True"  />
                        ...
                        <td class="auto-style280">
                            ...
                            <tr style="background-color: #D9E1F2; text-align:center">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style284">Personal 個人</td>
                                    ...
                                    <td class="auto-style311">3<span class="auto-style289">. Environment 5S (環境5S) <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="score1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score3"   AutoPostBack="True" runat="server" CssClass="auto-style165" Width="70px" ></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style321">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score4"   AutoPostBack="True" runat="server" CssClass="auto-style165" Width="70px" ></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                        2.Document and SAP control 文件和SAP管控</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                    ...
                                    <td class="auto-style130">5<span class="auto-style289">.Observation Skill,Detailed feedback to supervisors,Shift start/close Meeting Communication （觀察技巧，給主管的詳細反饋，輪班開始/結束會議溝通） <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="score2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                ...
                                <tr>
                                    <td class="auto-style130">6.Proposals to improve (提案改善) <em>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse; font-size:large; height:13%">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score7" runat="server"  AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="12" Width="70px" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score8" runat="server"  style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="13"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score9" runat="server"   style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="14"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
