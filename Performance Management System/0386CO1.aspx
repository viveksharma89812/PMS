<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CO1.aspx.vb" Inherits="Performance_Management_System._0386CO1" %>
...
//        // Ensure the canvas is fully loaded before trying to print
...
//        // Allow some time for the image to load before printing
    ...
    <div class="camera-container">
        ...
        <!-- Webcam Container -->
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                <table id="1" border="1" class="auto-style21" style="width:897px">
                    <tr>
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) 績效評核_可變薪酬評核表-僅適用於第三級作業職 (Main Calender OP ,Assitant ,Pre Calender OP,Extruder OP,Post Calender OP,Deliver OP)</td>
                                        </em>
                    ...
                    <tr>
                        <td class="auto-style31" style="font-weight:bold; text-align:center">
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130">4<span class="auto-style289">. Environment 5S (環境5S) <em>
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2">
                                        <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            <tr>
                                                ...
                                                <td class="auto-style122">Raw materials (Rubber and Fabric) 原材料 (膠料和原紗)<em><asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="score2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style122"> <em>
                                                    Semi-product (PLY and Chafer) 半製品 (簾布和防擦布)
                                    ...
                                    <td class="auto-style130"><em>5<span class="auto-style289">. Work assigned by Leader
                                        <br />
                                        上級交代事項 
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="score6" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></em></td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="2"> <em>
                                        6<span class="auto-style289">.Level-1 maintenance checkpoints check
                                        <br />
                                        一級保養 
                                ...
                                <tr>
                                    <td class="auto-style284">3<span class="auto-style289">.Production achievement rate 生產達成率 
                        ...
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                            ...
                            <tr>
                                <td class="auto-style137">1. Leader <em>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ldr" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </em></td>
                                ...
                                <td class="auto-style303">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304">
                                                <asp:TextBox ID="score8" runat="server" AutoPostBack="True" CssClass="auto-style165" Width="70px" TabIndex="8"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True" TabIndex="9"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <table class="nav-justified"  border="1" style="width:100%; border-collapse: collapse; text-align:center;">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style316"><strong>
                                        <asp:CheckBox ID="pass" runat="server" CssClass="auto-style280" Text="Pass" AutoPostBack="True" Enabled="False" />
                                        </strong></td>
                                    <td class="auto-style317">Total Score</td>
                                    <td class="auto-style122"><strong>
                                        <asp:CheckBox ID="extend" runat="server" CssClass="auto-style280" Text="Extend" AutoPostBack="True" Enabled="False" />
                                        </strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style122" colspan="4">
                                        ...
                                        &nbsp;<asp:TextBox ID="amnt2" runat="server" AutoPostBack="True" Width="32px" OnTextChanged="amnt2_TextChanged" ReadOnly="True"></asp:TextBox>
                                        &nbsp;<asp:CheckBox ID="Sub1" runat="server" AutoPostBack="True" Font-Bold="True" Font-Size="Small" Height="24px" Text=" Decrease" />
                                        &nbsp;&nbsp;<asp:TextBox ID="famnt1" runat="server" AutoPostBack="True" CssClass="auto-style214" Height="24px" style="font-family: Calibri; text-align:center; font-size: small" Width="150px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="auto-style122">
                            <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                <tr>
                                    ...
                                    <td class="auto-style117"><span class="auto-style280" id="sdecrease">Salary decrease </span><em>
                ...
                <table border="1" class="auto-style169"  style="width:100%; border-collapse: collapse; text-align:center;height:15%">
                    <tr>
...
<label id="lblEmpDate" runat="server"></label>
                    ...
                    <tr>
                        <td class="auto-style173" colspan="4" style="font-size:small">
