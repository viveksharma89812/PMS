<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site1.Master" CodeBehind="Upload Document.aspx.vb" Inherits="Performance_Management_System.WebForm6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional"><Triggers><asp:PostBackTrigger ControlID="empid" /><asp:PostBackTrigger ControlID="upload" /></Triggers><ContentTemplate>
    <br />
        <div class="container">
            <h2>Upload Documents of Employee</h2><hr />
            ...
            <div class="form-group"><br />
                 <asp:Button ID="upload" runat="server" CssClass="btn btn-primary"  TabIndex="4" Text="Upload" ValidationGroup="insert" Width="113px" />
                </div>
                  </div>
        </div>
  ...
  <div class="container"><h3>Search Details</h3><hr />
        ...
        <Columns>
            ...
            <%-- <asp:TemplateField HeaderText="FilePath">
             ...
             <asp:TemplateField HeaderText="Doc File">
                  <ItemTemplate>
                      <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/Images/" + Eval("FileName") %>' Text='<%# Bind("FileName") %>' Target="_blank"></asp:HyperLink>
               <%--  <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Bind("FileName") %>' CommandName="Download" Text='<%# Bind("FileName") %>'  OnClientClick="SetTarget()"></asp:LinkButton>--%>
                 ...
                 <EditItemTemplate>
                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "~/Images/" + Eval("FileName") %>' Text='<%# Bind("FileName") %>' Target="_blank" CssClass="hyper" Style="word-wrap:break-word;" ></asp:HyperLink>
