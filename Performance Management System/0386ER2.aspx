<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386ER2.aspx.vb" Inherits="Performance_Management_System._0386ER2" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff(Only for Level 2) Repair Engineer 領導/主管/一般員工績效考核表  僅適用於 第二級</td>
                                        </em>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse;font-size:large;height:13%">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score8" runat="server"  AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="12" Width="70px" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em>
                                ...
                                <td class="auto-style122">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score9" runat="server"  AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="12" Width="70px" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em> 
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score10" runat="server"   style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="14"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
