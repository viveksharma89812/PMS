<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386QIL2.aspx.vb" Inherits="Performance_Management_System._0386QIL2" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor (Only for Level 2) Shop floor/ Inspection Shift <br />領導/主管/一般員工績效考核表  僅適用於 第二級    </td>
                                        </em>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse;">
                               ...
                               <tr>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">4. Daily Rejection cleareance & data monitoring of daily rejection record 每日拒收清關及每日拒收記錄數據監控</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">10%</td>
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score12" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align:center" TabIndex="12" Width="122px" Height="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style327">3<em>%</span></em> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score13" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center" TabIndex="13" Height="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
