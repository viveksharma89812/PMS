    ...
    Protected Sub insert_Click(sender As Object, e As EventArgs) Handles insert.Click
        Try
            ...
            ElseIf score1.SelectedIndex = "4" Then
                marks = "0"
            End If
            strsql = "update" + " " + tot + " " + "set Score1='" & marks & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',TotalMarks='" & totscore.InnerText & "',Remark='" & remark.Text & "',Form_Status='DONE',Form_ID='7' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
