<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0399_Rd2_Mold.aspx.vb" Inherits="Performance_Management_System.WebForm36" %>
    ...
    <center><asp:Label ID="Label4" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="892px" BackColor="#ffffff">
            ...
            <table style="width:100%" border="1">
                <tr>
                    <td colspan="10" style="font-weight:bold">
                        Permanent Period Review Form (For RD2_Mold Operator) 正式期評核表(作業人員)</td>
                </tr>
                 <tr>
                 ...
                 <tr>
                     ...
                     <td colspan="2" class="auto-style69">
                         <asp:Label ID="empname" runat="server" Text="Label"></asp:Label>
                      </td>
                      <td class="auto-style66" >Employee Code</td>
                 ...
                 <tr>
                     ...
                     <td colspan="2" style="text-align:left" class="auto-style5">1. Attitude of work(Initiative)</td>
                      <td class="auto-style68">
                          20%</td>
                     <td colspan="3" style="text-align:left" class="auto-style5">&nbsp;2.Mold cleaning rate 洗模達成率</td>
                 </tr>
                 <tr>
                     ...
                     <td colspan="2" style="text-align:left">* Excellent=20 Point</td>
                      <td rowspan="5" class="auto-style67">
                 ...
                 <tr>
                     ...
                     <td colspan="2" style="text-align:left">* Good=15 Point</td>
                     <td style="text-align:left" colspan="3">&nbsp;3.(previous)Customer complaints rate 上工程客訴率</td>
                 </tr>
                 <tr>
                      <td class="auto-style62">CL</td>
                     ...
                     <td colspan="2" style="text-align:left">* Satisfactoryt= 10 point</td>
                     <td>30 %</td>
                      <td colspan="2">
                 ...
                 <tr>
                     ...
                     <td colspan="2" style="text-align:left">* Improvement Required=5 Point</td>
            ...
            <table border="1" style="width:100%">
                <tr>
                    <td class="auto-style65" style="background-color:#eea236">Remarks</td>
                    <td class="auto-style48">Status of probation / Training period</td>
                    <td class="auto-style45" style="font-weight:bold">
                        <asp:CheckBox ID="pass" runat="server" Text="Pass" />
                    </td>
                    <td class="auto-style70" style="font-weight:bold">
                ...
                <tr>
                    <td class="auto-style65" rowspan="3" style="text-align:left; font-size:small">Performance status definition :考核結果說明 <br /> 1.Pass: Score is 76 or more than 76 every time<br /> &nbsp;適任: 分數高於76分 
                        <br />
                        2.Extend : Score is 75 or below 75, turn to extend <br /> period(PIP), employee has three months to improve 
                        <br />
                        his/her performance.<br /> &nbsp;延長:分數低於75分，進入績效改善階段，<br />
                        共三個月之改善期間。</td>
