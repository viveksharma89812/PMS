<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Auditing_New.aspx.vb" Inherits="Performance_Management_System.Auditing_New" %>
...
<u style="color:red"><span style="color:red; ">  Auditing  </span></u> 領導/主管/員工績效考核表（僅適用於二級）審核</td>
                                        </em>
                                    </tr>
                                </table>
                            </center>
                            ...
                            <tr style="background-color: #D9E1F2; text-align:center">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                      2. Tax audit and return filling  稅務審計及申報表填寫</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                     3.Transfer Price Audit Income tax 轉讓價格審計所得稅</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                      4. Statutory audit as per Indian Laws 根據印度法律進行法定審計</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                    5. Internal audit as per Indian Laws 根據印度法律進行內部審計</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
