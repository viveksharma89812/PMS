<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master"  CodeBehind="0386TSPO2.aspx.vb" Inherits="Performance_Management_System._0386TSPO2" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) Semi-product 績效評核_可變薪酬評核表-僅適用於第三級作業職</td>
                                        </em>
                                        ...
                                        <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            <tr>
                                                ...
                                                <td class="auto-style301">
                                                    <asp:Label ID="empname" runat="server" CssClass="auto-style280" Text="Lable"></asp:Label>
                                                </td>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="2">4<span class="auto-style289">. Environment 5S (環境5S) <em>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="3"><em>&nbsp;5. Near miss, accident, unsafe condition (nos) (未遂事件、事故、不安全狀況（否）)
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="score6" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style129" rowspan="3">
                                        <em>
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">3<span class="auto-style289">.Wrong delievery (備料錯誤) 
                        ...
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="10"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="11"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <em>
                                    <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="dhead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="12"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                            ...
                            <table class="nav-justified"  border="1" style="width:100%; border-collapse: collapse; text-align:center;">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style122" colspan="4">
                                        <asp:TextBox ID="famnt" runat="server" CssClass="auto-style214" Height="24px" style="font-family: Calibri; text-align:center; font-size: small" Width="150px" AutoPostBack="True"></asp:TextBox>
                                        <asp:CheckBox ID="plus" runat="server" AutoPostBack="True" Font-Bold="True" Font-Size="Small" Height="24px" Text="Increase" Width="65px" />
                                        <asp:TextBox ID="amnt2" runat="server" Width="32px" AutoPostBack="True" OnTextChanged="amnt2_TextChanged" ReadOnly="True"></asp:TextBox>
...
<label id="lblEmpDate" runat="server"></label>
    ...
    <div style="text-align: right;">A4/A3 No. 0399-1</div>
            ...
            <asp:Button ID="insert" runat="server" cssclass="btn btn-primary" style="font-family: call; font-size: small;" Text="Submit" ValidationGroup="insert" />
                <em>&nbsp;</td></tr></em></em><span class="auto-style184"><asp:Button ID="update" runat="server" cssclass="btn btn-primary" OnClick="update_Click" style="font-family: call; font-size: small;" Text="Update" ValidationGroup="insert" />
