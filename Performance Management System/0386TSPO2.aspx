                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表TB -Semi-product 半成品</td>
                                        </em>
                        ...
                        <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style303">
                                    <asp:CheckBoxList ID="score7" runat="server" RepeatDirection="Horizontal" Width="188px" AutoPostBack="True" Height="20px">
                                        <asp:ListItem vale="4">4%</asp:ListItem>
