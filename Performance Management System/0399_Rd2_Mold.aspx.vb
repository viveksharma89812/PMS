    ...
    Protected Sub insert_Click(sender As Object, e As EventArgs) Handles insert.Click
        Try
            ...
            ElseIf fail.Checked = True Then
                status = "Fail"
            End If
            strsql = "update" + " " + tot + " " + "set Score1='" & marks & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',TotalMarks='" & totscore.InnerText & "',Remark='" & remark.Text & "',Status='" & status & "',Form_Status='DONE',Form_ID='21' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
