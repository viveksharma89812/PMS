<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0366GAORPS.aspx.vb" Inherits="Performance_Management_System._0366GAORPS" %>
...
<center><asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="882px" BackColor="#ffffff">
        <table class="auto-style3" border="1"  Width="882px" Height="20%"  style="width:100%; text-align:center; border-collapse: collapse;font-size:large">
            <tr>
                <td colspan="6" style=" font-style: oblique; font-weight:bold" onclick="return false"><asp:CheckBox ID="c1" runat="server"></asp:CheckBox> Training / <asp:CheckBox ID="c2" runat="server"></asp:CheckBox> Probation Period Review Form (For Administration Operator)訓練期/試用期評核表(作業人員)</td>
            </tr>
            <tr>
        ...
        <table class="auto-style3" border="1" Height="65%" style="width:100%; text-align:center; border-collapse: collapse;font-size:large">
        <tr>
        ...
        <tr>
            ...
            <td colspan="4">
                <asp:TextBox ID="remark" runat="server" Width="100%" Height="100%" cssclass="form-control" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
