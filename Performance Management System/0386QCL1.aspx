<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386QCL1.aspx.vb" Inherits="Performance_Management_System._0386QCL1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2) Calibration Supervisor 領導/主管/一般員工績效考核表  僅適用於 第二級    </td>
                                        </em>
                    ...
                    <tr>
                        <td class="auto-style280">
                               ...
                               <tr>
                                    ...
                                    <td class="auto-style130">6. Environment 環境5S /Safety  5S/安全</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score6" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" style="text-align:center" TabIndex="7"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                               ...
                               <tr>
                                    <td class="auto-style284" colspan="2" >2.Monthly Calibration of Intruments & equipments 儀器設備每月校準</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">35%</td>
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score2" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" style="text-align:center" TabIndex="1"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style130">7.Team Management 團隊管理</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</span></td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">3. Timely Submission of C.S.T.G Policy data & related documents 及時提交C.S.T.G政策數據及相關文件</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">12%</td>
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score3" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" style="text-align:center" TabIndex="1"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style130">8.Employee Behaviour (員工行為)</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score8" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" style="text-align:center" TabIndex="7"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">4. Customer Complaints handling & their timely closures 客戶投訴處理及及時關閉</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">10%</td>
                                    ...
                                    <td class="auto-style130">9.Problem solving skills(解決問題的能力)</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" style="text-align:center" TabIndex="7"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">5.Continuous Improvement 連續的提高 (Monthly Kaizen submissions) (每月改善提交）</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">9%</td>
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score5" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" style="text-align:center" TabIndex="1"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style130">10.Self Initiative approach   自我主動的方法</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" style="text-align:center" TabIndex="7"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
