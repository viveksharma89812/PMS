<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0366_Utility.aspx.vb" Inherits="Performance_Management_System.WebForm26" %>
...
<center><asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="882px" BackColor="#ffffff">
        <table class="auto-style3" border="1">
            <tr>
                <td colspan="6" style=" font-style: oblique; font-weight:bold" onclick="return false"><asp:CheckBox ID="c1" runat="server"></asp:CheckBox> Training / <asp:CheckBox ID="c2" runat="server"></asp:CheckBox> Probation Period Review Form (For Engineering(Utility) Operator)訓練期/試用期評核表(作業人員)</td>
            </tr>
            <tr>
        ...
        <tr>
            ...
            <td class="auto-style29" style="text-align:left">* Excellent=10 Point</td>
            ...
            <tr>
                ...
                <td class="auto-style29" style="text-align:left">* Good=8 Point</td>
        ...
        <tr>
            ...
            <td class="auto-style29" style="text-align:left">* Satisfactoryt= 5 point</td>
        </tr>
        <tr>
            ...
            <td class="auto-style29" style="text-align:left">* Improvement Required=3 Point</td>
            <td class="auto-style36" rowspan="2" style="font-weight:bold; background-color:#eea236">Total Scores</td>
