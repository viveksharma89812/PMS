                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表 Cutting OP (PLY/Chafer Cutting Splitting /Bead Wire Building/Bead Filler)</td>
                                        </em>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score8" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
