<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CO2.aspx.vb" Inherits="Performance_Management_System._0386CO2" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) 績效評核_可變薪酬評核表-僅適用於第三級作業職 Cutting OP (PLY/Chafer Cutting Splitting /Bead Wire Building/Bead Filler)</td>
                                        </em>
                            ...
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2">
                                        <table class="nav-justified" style="width:100%; border-collapse: collapse; text-align:center" border="1">
                                            <tr>
                                                <td class="auto-style325"><br/><br/>2.Defective Rate/ Scrap Rate 不良率/報廢率<br/><br/></td>
                                                <td class="auto-style122">Raw materials (Rubber and Steel cord). Semi-product (PLY, Chafer, BW, and BF) 原材料 (膠料和鋼絲)、半製品 (簾布、防擦布、鋼絲圈和三角膠)<em><asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="score2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">25%</span></td>
                                                <td class="auto-style131">
                                    ...
                                    <td class="auto-style130"><em>5<span class="auto-style289">. Work assigned by Leader
                                        <br />
                                        上級交代事項 
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="score5" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></em></td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style130" rowspan="2"> <em>
                                        ...
                                        <br />
                                        一級保養 
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="score6" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284">3<span class="auto-style289">.Production achievement rate 生產達成率 
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="score3" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></td>
                        ...
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                           <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score8" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True" TabIndex="8"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="9"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
    ...
    <div style="text-align: right;">A4/A3 No. 0399-1</div>
           ...
           <br />
               <asp:Button ID="insert" runat="server" cssclass="btn btn-primary" style="font-family: call; font-size: small;" Text="Submit" ValidationGroup="insert" />
                ...
                &nbsp;<span class="auto-style184"><em><asp:Button ID="update" runat="server" cssclass="btn btn-primary" OnClick="update_Click" style="font-family: call; font-size: small;" Text="Update" ValidationGroup="insert" />
                &nbsp;</em></span><em><span class="auto-style184"><asp:Button ID="show" runat="server" cssclass="btn btn-primary" style="font-family: call; font-size: small;" Text="Show" ValidationGroup="insert" />
                </span></em>
