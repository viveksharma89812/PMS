<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0364PS1.aspx.vb" Inherits="Performance_Management_System._0364PS1" %>
            ...
            <table id="1" border="1" class="auto-style21" style="visibility: visible; width:915px; list-style-type: circle; table-layout: fixed; border-collapse: separate; border-spacing: inherit;width:100%; text-align:center; border-collapse: collapse;font-size:large">
                <tr>
                    <td class="auto-style31" colspan="6" style="font-size:large; font-style: oblique; font-weight:bold ">
                            ...
                            Training / Probation Period During Review Form (For Planning Staff) 訓練/試用期審查表（規劃人員）</td>
                </tr>
                <tr>
           ...
           <table class="auto-style20" border="1" style="width:100%;  border-collapse: collapse;font-size:large;height:13%">
            ...
            <table id="3" border="1" class="auto-style114" style="width:100%; text-align:center; border-collapse: collapse;font-size:large" >
             <tr>
                 ...
                 <tr>
                 <td  rowspan="3" style="text-align:left; width:500px; font-size:large"  >1. Part A & B provided by HR Dept. A及B部分由人資提供<br /> 2. Review employees&#39; performance in this period and give feedback or guidance in point 7. 評核該區間之表現並給予回饋。<br /> 3. Fail definition: 不適任說明：<br /> Training: 訓練期 
