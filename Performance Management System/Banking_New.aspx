<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Banking_New.aspx.vb" Inherits="Performance_Management_System.Banking_New" %>
...
<u style="color:red"><span style="color:red; "> Banking  </span></u>  領導/主管/員工績效考核表（僅適用於二級） 銀行業 </td>
                                        </em>
                                    </tr>
                                </table>
                            </center>
                            ...
                            <tr style="background-color: #D9E1F2; text-align:center">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                       2.Passing entry in SAP 在 SAP 中傳遞條目</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                     3.Bank Reconciliation statement 銀行存款餘額調節表</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                       4. Salary processing , Payment advices 薪資處理、付款建議</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                     5.Forex payment clearing & Bank document  Prepare  外匯支付清算和銀行文件準備</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
