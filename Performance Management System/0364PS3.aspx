<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0364PS3.aspx.vb" Inherits="Performance_Management_System._0364PS3" %>
...
<div id="outerimgdiv" style="position:fixed;" runat="server">
          ...
          <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" EnableViewState="true" Width="920px" BackColor="#ffffff" CssClass="auto-style99">
            ...
            <table id="1" border="1" class="auto-style21" style="visibility: visible; width:915px; list-style-type: circle; table-layout: fixed; border-collapse: separate; border-spacing: inherit;  width:100%; text-align:center; border-collapse: collapse;font-size:large">
                <tr>
                    <td class="auto-style31" colspan="6" style="font-size:large; font-style: oblique; font-weight:bold ">
                        ...
                        Performance Review  Form (For Permanent Planning Staff) 績效考核表（常駐規劃人員）</td>
                </tr>
                <tr>
            ...
            <table id="2" border="1" class="auto-style20"  style="width:100%; text-align:center; border-collapse: collapse;" >
                <tr>
                    ...
                    <td class="auto-style43" colspan="1" style="font-weight:bold;background-color:#eea236">30%</td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style688">Other leave</td>
    ...
    <asp:ListItem  Value="1" onclick="MutExChkList1(this);" />
                ...
                <tr>
                    <td class="auto-style86" colspan="2" style="text-align:left"><b>2. Problem analysis and resolution(問題分析及解決能力) :</b> Ability to gather and analyse relevant data to solve problems and make decisions within the scope of authority.</td>
    ...
    <asp:ListItem  Value="1" onclick="MutExChkList2(this);" />
                ...
                <tr>
                    <td class="auto-style86" style="text-align:left" colspan="2"><b>3. Plan ability and Quality of Work(工作計畫與品質) : </b>Can prepare action plan for short-term or long-term also follow it and maintain 'Quality Standard' of work. </td>
    ...
    <asp:ListItem  Value="1" onclick="MutExChkList4(this);" />
                ...
                <tr>
                    <td class="auto-style86" style="text-align:left" colspan="2"><b>5. Involvement/participation in team effort(團隊合作) : </b>Can inspire confidence in others and creates enthusiasm and ensures collaboration amongst team members to attain stated objectives.</td>
    ...
    <asp:ListItem  Value="1" onclick="MutExChkList5(this);" />
           ...
           <table class="auto-style20" border="1" style="width:100%;  border-collapse: collapse;font-size:large;height:13%">
                 <tr><td style="width:170px;font-size:x-large">6. Summarise the   &amp;
                     <br />
                   the overallperformance or comment :
                     <br />
                     總評建議: &nbsp;<%--<asp:Button ID="Button4" runat="server" Text="+" CssClass="btn btn-primary" />--%></td>
        ...
        <table border="1" class="auto-style169"style="width:100%; text-align:center; border-collapse: collapse;font-size:large">
                            ...
                            <em>
                            <tr>
                                <td class="auto-style172" rowspan="3" style="text-align:left; color:deepskyblue; font-size:x-large"><span class="auto-style280">1. Part A & B provided by HR Dept. A<br />及B部分由人資提供。 </span>
