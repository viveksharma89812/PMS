<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="ReSalesStaff.aspx.vb" Inherits="Performance_Management_System.ReSalesStaff" %>



<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>ReSales Page</title>
    <%-- Add charset for better character rendering --%>
    <meta charset="utf-8" />
    <style>
        body {
    ...
    table {
        ...
        border-collapse: collapse;
        table-layout: auto !important; /* Important: Distributes column widths evenly or as specified */
    }
                ...
                <div class="form-container">
                    <table>
                        <tr class="header-title">
                            <td colspan="18">Performance Review Form <span class="pink-text">(For Commercial Staff) 績效考核表 （適用於商業人員）</span></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="16" class="section-title">B. Evaluation Result of Sales Performance (by HR)</td>
                        ...
                        <tr class="chocolate-bg">
                            ...
                            <td colspan="4">Team rate<br>團隊率</td>
                        </tr>
                        ...
                        <tr class="text-center bold">
                            ...
                            <td rowspan="3" colspan="9" class="text-left">Comments:    <asp:TextBox ID="remark" runat="server" TextMode="MultiLine" cssclass="form-control"></asp:TextBox></td>
                        </tr>
