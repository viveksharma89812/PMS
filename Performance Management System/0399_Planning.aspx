<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0399_Planning.aspx.vb" Inherits="Performance_Management_System.WebForm33" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center><asp:Label ID="Label4" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="904px" BackColor="#ffffff">

            <table style="width:100%" border="1">
                <tr>
                    <td colspan="10" style="font-weight:bold">
                       Permanent Period Review Form (For Planning Operator) 正式期評核表(作業人員)</td>
                </tr>
                 <tr>
                 ...
                 <tr>
                     ...
                     <td colspan="2" class="auto-style67">
                         <asp:Label ID="empname" runat="server" Text="Label"></asp:Label>
                      </td>
                      <td class="auto-style64" >Employee Code</td>
                 ...
                 <tr>
                     ...
                     <td colspan="2" style="text-align:left" class="auto-style5">1. Attitude of work(Initiative)</td>
                      <td class="auto-style62">
                          20%</td>
                     <td colspan="3" style="text-align:left" class="auto-style5">&nbsp;2. Accuracy of work產能達成率</td>
                 </tr>
                 <tr>
                     ...
                     <td colspan="2" style="text-align:left">* Excellent=20 Point</td>
                      <td rowspan="5" class="auto-style63">
                 ...
                 <tr>
                     ...
                     <td style="text-align:left" colspan="3">&nbsp; 3. Quality &amp; Productivity of work品質良率</td>
                 </tr>
                 <tr>
                      <td class="auto-style66">CL</td>
            ...
            <table border="1" style="width:100%">
                <tr>
                    ...
                    <td class="auto-style72" style="font-weight:bold">
