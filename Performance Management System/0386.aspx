<%@ Page Title="" Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386.aspx.vb" Inherits="Performance_Management_System.WebForm10" %>
        ...
        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="900px" BackColor="#ffffff">
            ...
            <table id="tb1" runat="server" border="1" class="auto-style20">
                ...
                <tr>
                    ...
                    <td class="auto-style105">20<asp:CustomValidator ID="CustomValidator2" ValidationGroup="insert"  runat="server" ErrorMessage="select at least one item." Text="*" ForeColor="Red" ClientValidationFunction="ValidateCheckBoxList1"></asp:CustomValidator></td>
                    <td colspan="5">
                ...
                <tr>
                    ...
                    <td class="auto-style105">15<asp:CustomValidator ID="CustomValidator5" ValidationGroup="insert" runat="server" ErrorMessage="select at least one item." Text="*" ForeColor="Red" ClientValidationFunction="ValidateCheckBoxList4"></asp:CustomValidator></td>
                    <td colspan="5">
