                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表 Curing Leader 加硫主管 /Bladder Leader 氣囊袋助理</td>
                                        </em>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified">
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">
                                        <table class="auto-style326">
                                            <tr>
                                                <td class="auto-style122">2. Achievement rate 生產達成率</td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130">6.Kizen Proposals to improve (提案改善)<em><asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="TextBox1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="TextBox29" runat="server" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:CheckBoxList ID="CheckBoxList2" runat="server" RepeatDirection="Horizontal" Width="188px">
                                        <asp:ListItem>  4%</asp:ListItem>
                                        <asp:ListItem>  3%</asp:ListItem>
                                        <asp:ListItem>  2%</asp:ListItem>
                                        <asp:ListItem>  1%</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:CheckBoxList ID="CheckBoxList3" runat="server" RepeatDirection="Horizontal" Width="188px">
                                        <asp:ListItem>  4%</asp:ListItem>
                                        <asp:ListItem>  3%</asp:ListItem>
                                        <asp:ListItem>  2%</asp:ListItem>
                                        <asp:ListItem>  1%</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="TextBox27" runat="server" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:TextBox ID="TextBox28" runat="server" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
