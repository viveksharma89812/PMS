<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CUL1.aspx.vb" Inherits="Performance_Management_System._0386CUL1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)  Curing Leader  /Bladder Leader 領導/主管/一般員工績效考核表僅適用於 第二級 </td>
                                        </em>
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score3" runat="server" TabIndex="3"  AutoPostBack="True" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129">
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score6" runat="server" AutoPostBack="True" TabIndex="6" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score4" runat="server" AutoPostBack="True" TabIndex="4" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score7" runat="server" AutoPostBack="True" TabIndex="7" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                ...
                <tr>
                 ...
                 <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse;font-size:large">
                            <tr>
                                ...
                                <td class="auto-style314" style="background-color: #FFD966; text-align:center"><strong>12%</strong></td>
                            </tr>
                            <tr>
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score8" runat="server"  AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="8" Width="70px" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <tr>
                                <td class="auto-style291">3. Production Head</td>
