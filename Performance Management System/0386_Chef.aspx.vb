...
Public Class _0386_Chef
            ...
            If sqlselect(constr, strsql, "Abc") Then
                If ds.Tables("Abc").Rows.Count > 0 Then
                    ...
                    If deptsi = "Done" Or sectsi = "Done" Then
                        ...
                        CheckBoxList2.SelectedValue = sco2 / 5
                        ...
                        CheckBoxList3.SelectedValue = sco3 / 5
                        ...
                        CheckBoxList4.SelectedValue = sco4 / 4
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles insert.Click
        ...
        If deptsign.Checked = True Then
            strsql = "update" + " " + tot + " " + "set Score1='" & scor1.Text & "',Score2='" & scor2.Text & "',Score3='" & scor3.Text & "',Score4='" & scor4.Text & "',TotalMarks='" & totmarks.InnerText & "',Remark='" & remark.Text & "',Status='" & reviewstatus.SelectedValue & "',Form_Status='DONE',Form_ID='26', Dept_Accept='" & deptaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
        ...
        End If
        If sectsign.Checked = True Then
            strsql = "update" + " " + tot + " " + "set Score1='" & scor1.Text & "',Score2='" & scor2.Text & "',Score3='" & scor3.Text & "',Score4='" & scor4.Text & "',TotalMarks='" & totmarks.InnerText & "',Remark='" & remark.Text & "',Status='" & reviewstatus.SelectedValue & "',Form_Status='PENDING',Form_ID='26',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
            If sqlexe(constr, strsql) Then
        ...
        If deptsign.Checked = True And sectsign.Checked = True Then
            strsql = "update" + " " + tot + " " + "set Score1='" & scor1.Text & "',Score2='" & scor2.Text & "',Score3='" & scor3.Text & "',Score4='" & scor4.Text & "',TotalMarks='" & totmarks.InnerText & "',Remark='" & remark.Text & "',Status='" & reviewstatus.SelectedValue & "',Form_Status='DONE',Form_ID='26', Dept_Accept='" & deptaccept & "',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
            If sqlexe(constr, strsql) Then
