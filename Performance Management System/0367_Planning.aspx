<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0367_Planning.aspx.vb" Inherits="Performance_Management_System.WebForm28" %>
    ...
    <center><asp:Label ID="Label4" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="892px" BackColor="#ffffff">
            ...
            <table style="width:100%" border="1">
                <tr>
                    <td colspan="10" style="font-weight:bold" onclick="return false">
                        <asp:CheckBox ID="ID1" runat="server" />
                        Training /
                        <asp:CheckBox ID="ID2" runat="server" />
                        Probation Period Review Form (For Planning Operator)訓練期/試用期評核表(作業人員)</td>
                </tr>
                 <tr>
