                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) Mold 績效評核_可變薪酬評核表-僅適用於第三級作業職</td>
                                        </em>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                            <tr>
                                ...
                                <td class="auto-style314" style="background-color: #FFD966; text-align:center">16<strong>%</strong></td>
                            </tr>
                            <tr>
                                <td class="auto-style313" style="background-color: #FFD966; text-align:center">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style333">(0% but can change all)</td>
                                        </tr>
                                    </table>
                                </td>
                                <tr>
                                    ...
                                    <td class="auto-style138">
                                        <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="12"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style138">
                                        <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="13"></asp:TextBox>
                                    </td>
                                    <td class="auto-style122">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style327">12</td>
                                                <td class="auto-style303">
                                                    <em>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style138">
                                        <asp:TextBox ID="dhead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="14"></asp:TextBox>
                                    </td>
                                    <td class="auto-style122">
                                        <asp:TextBox ID="score11" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True" TabIndex="11"></asp:TextBox>
                                    </td>
                                </tr>
                            </tr>
                        </table>
...
<label id="lblEmpDate" runat="server"></label>
                ...
                <div style="display: flex; width:900px; justify-content: space-between; align-items: flex-end; text-align: center; margin-top:1px;">
    ...
    <div style="text-align: right;">A4/A3 No. 0399-1</div>
            ...
            <center>
                ...
                <span class="auto-style184"><%--<asp:Button ID="Button2" runat="server" CssClass="auto-style102" Height="43px" Text="Export To PDF" />--%>&nbsp;<em><asp:Button ID="update" runat="server" cssclass="btn btn-primary" OnClick="update_Click" style="font-family: call; font-size: small;" Text="Update" ValidationGroup="insert" />
