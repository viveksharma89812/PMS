<%@ Page Title="" Language="vb"   AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Import excel.aspx.vb" Inherits="Performance_Management_System.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server"><Triggers><asp:PostBackTrigger ControlID="Button1" /></Triggers><ContentTemplate><br />
       <div class="container">
         <h2>Please Upload Attendance Excel File</h2><hr />
         <div class="col-sm-4 col-md-4 col-lg-4">
          ...
          <div class="col-sm-4 col-md-4 col-lg-4">
             <div class="form-group"><br />
                   <asp:Button ID="Button1" runat="server" Text="Import" ValidationGroup="insert" cssclass="btn btn-primary" />   <asp:Button ID="Button2" runat="server" Text="Send Mail" CssClass="btn btn-primary" />   
                 </div>
              </div>
     ...
     <asp:ValidationSummary ID="ValidationSummary1" runat="server" CssClass="auto-style1" ForeColor="Red" Width="308px" ShowMessageBox="True" ShowSummary="False" ValidationGroup="insert" />
         ...
         <asp:HiddenField ID="hfScrollPosition" Value="0" runat="server"  />
          <div id="dvScroll" class="divcss" onscroll="setScrollPosition(this.scrollTop);" style="width:auto; height:430px;  border-style:groove; font-family:Calibri; Font-Size:Small " >
