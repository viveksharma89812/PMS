<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386M2.aspx.vb" Inherits="Performance_Management_System._0386M2" %>
    ...
    <div class="camera-container">
        ...
        <!-- Webcam Container -->
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                <table id="1" border="1" class="auto-style21" style="width:100%">
                    <tr >
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form for leader/Supervisor/Staff (Only for Level 2) Mixing Supervisor 領導/主管/一般員工績效考核表 僅適用於 第二級 </td>
                                        </em>
                ...
                <table id="2"  class="auto-style20" style="width:100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td class="auto-style280">
                            <table class="nav-justified" border="1" style="width:100%; border-collapse: collapse;">
                                <tr style="text-align:center;height:30%;background-color: #D9E1F2;text-align:center"">
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <em>
                                                    <asp:TextBox ID="score1" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="1" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="nav-justified"   style="width:100%; border-collapse: collapse;">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score7" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="7" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style321">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score2" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="2" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score3" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="3" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score9" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="9" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <em>
                                                    <asp:TextBox ID="score4" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="4" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style129" rowspan="2"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score10" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="10" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <em>
                                                    <asp:TextBox ID="score5" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="5" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <em>
                                                    <asp:TextBox ID="score6" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="6" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score11" runat="server" AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="11" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                ...
                <tr>
                    <td class="auto-style280">
                        <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse; height:10%">
                            <tr>
                                <td class="auto-style312" colspan="2" style="background-color:#8EA9DB;"><strong>D. Department/Section Review 部門/部門審查</strong></td>
                                <td class="auto-style314"  style="background-color: #FFD966;">0<strong>%</strong></td>
                            </tr>
                             
                            <tr>
                                <td class="auto-style332">1. Supervisor</td>
                                ...
                                <td class="auto-style297">
                                    <asp:TextBox ID="score12" runat="server" CssClass="auto-style165" style="text-align: center" Width="244px" AutoPostBack="True" TabIndex="10"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score13" runat="server" style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="12"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score14" runat="server" CssClass="auto-style165" style="text-align: center" Width="244px" AutoPostBack="True" TabIndex="13"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                 ...
                 <table id="tb1" runat="server" border="1" class="auto-style20" style="width:100%; border-collapse: collapse; height:10%;font-size:large">
                            <tr>
                                <td class="text-center" style="width:180px"><strong>Recommendation &amp; Summaries the overall performance and progress 建議和總結該員整體表現</strong></td>
                                <td class="auto-style83">
  <asp:TextBox ID="remark" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
    CssClass="form-control" Height="70px" style="width:100%; height:100%;font-size:x-large;" TextMode="MultiLine" TabIndex="16"
    onkeyup="checkLength();"></asp:TextBox>                                </td>
                            </tr>
                        </table>
                        <table border="1" class="auto-style169" style="width:100%; border-collapse: collapse; text-align:center; height:20%; font-size:large">
                            <tr>
