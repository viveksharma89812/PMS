<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CNC2.aspx.vb" Inherits="Performance_Management_System._0386CNC2" %>
        ...
        <!-- Webcam Container -->
           <div id="printableContent">
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2) CNC <br /> 領導/主管/一般員工績效考核表  僅適用於 第二級</td>
                                        </em>
                    ...
                    <tr>
                        <td class="auto-style280">
                          <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse;height:10%">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="1" colspan="2" >1. Attendance 出勤率</td>
                                   
                                    <td class="auto-style310" rowspan="1" >
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style324" rowspan="2"><br />2.Defective Rate/Scrap Rate 不良率/報廢率<br /></td>
                                                <td class="auto-style122">Rubber Scrap 膠料報廢<em>
                                            ...
                                            <tr>
                                                <td class="auto-style122">RN generation 回收膠<em>
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score2"  runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align: center" TabIndex="3" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style130">7<span class="auto-style289">.Work assigned by Leader
                                        <br />
                                         上級交代事項 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="score7" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score7" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align: center" TabIndex="9" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" >7.Level-1 maintenance checkpoints check  一級保養 <em>
                                    ...
                                    <td class="auto-style129" ><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score8" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align: center" TabIndex="10" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <em>
                                                    <asp:TextBox ID="score4" runat="server" AutoPostBack="True" CssClass="auto-style165"  style="text-align: center" TabIndex="5" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                     <td class="auto-style130" rowspan="2">8.Proposals to improve (提案改善)&nbsp;
                                    ...
                                    <td class="auto-style129" rowspan="2" ><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <em>
                                                    <asp:TextBox ID="score9" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align: center" TabIndex="11" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">4<span class="auto-style289">.Fabrication of Die 口金製作
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <em>
                                                    <asp:TextBox ID="score5" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align: center" TabIndex="6" Width="70px"></asp:TextBox>
                                                    </em>
                                                </td>
                                            </tr>
                                        </table>
                ...
                <tr>
                    <td class="auto-style280">
                                              <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse;font-size:large;height:12% ">
                            ...
                            <tr>
                                ...
                                <td class="auto-style325">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" TabIndex="13" MaxLength="25" style="text-align: center"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score11" runat="server" style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="13"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score12" runat="server" style="text-align: center" CssClass="aCNC2uto-style165" Width="244px" AutoPostBack="True" TabIndex="14"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                ...
                <table id="tb1" runat="server" border="1" class="auto-style20"  style="width:100%;  border-collapse: collapse;height:13%;font-size:large">
                            <tr>
