<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Finance_Accounting_Payable_New.aspx.vb" Inherits="Performance_Management_System.Finance_Accounting_Payable_New" %>
...
<u style="color:red"><span style="color:red; ">  Finance Accounting-Payble  </span></u> 領導/主管/員工績效考核表（限二級） 財務會計 應付的</td>
                                        </em>
                                    </tr>
                                </table>
                            </center>
                            ...
                            <tr style="background-color: #D9E1F2; text-align:center">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                     2.MIRO Invoice check And verification 本地付款表和智慧表格準備</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                    3.GA Invoice booking GA 發票預訂</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                     4.Document upload HQ 文件上傳總部</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                   5.All invoice verification  所有發票驗證</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
