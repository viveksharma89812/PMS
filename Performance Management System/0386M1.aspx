            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表control room supervisor 中控室主管</td>
                                        </em>
                                        ...
                                        <table class="nav-justified">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style122" colspan="2">
                                                    <asp:CheckBox ID="trai" runat="server" CssClass="auto-style280" Text="Training" />
                                                    &nbsp;<asp:CheckBox ID="prob" runat="server" CssClass="auto-style280" Text="Probation" />
                                                    &nbsp;<asp:CheckBox ID="conf" runat="server" CssClass="auto-style280" Text="Confirm" />
                                                </td>
                                                <td class="auto-style122" colspan="3">Year : <em>
                                                    <asp:Label ID="revmonth" runat="server" CssClass="auto-style280" Text="Label"></asp:Label>
                                                    &nbsp;
                                                    </em>
                                                    <asp:CheckBox ID="month" runat="server" CssClass="auto-style280" Text="Monthly" />
                            ...
                            <table class="nav-justified">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style284" colspan="2">2.<span class="auto-style289">Production achievement rate 生產達成率 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="score3" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">3<span class="auto-style289">.Operating Conditions/Parameters/Scheduling wrong setting 作業條件/參數/排程設定錯誤<em><asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="score4" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">4<span class="auto-style289">.Defective rate 不良率<em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="score5" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                    ...
                                    <td class="auto-style130">8.Proposals to improve (提案改善)&nbsp;
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="score9" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                ...
                <tr>
                    <td class="auto-style280">
                        <table class="nav-justified">
                            <tr>
                                <td class="auto-style312" colspan="2"><strong>D. Leaders Review 領導者</strong></td>
                                <td class="auto-style314">0<strong>%</strong></td>
                            </tr>
                            <tr>
                                <td class="auto-style291">1. Section Head</td>
                                <td class="auto-style138">
                                    <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style291">2. Department Head</td>
                                <td class="auto-style138">
                                    <asp:TextBox ID="dhead" runat="server" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:TextBox ID="score11" runat="server" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                            ...
                            <table class="nav-justified">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style316"><strong>
                                        <asp:CheckBox ID="pass" runat="server" CssClass="auto-style280" Text="Pass" />
                                        </strong></td>
                                    <td class="auto-style317">Total Score</td>
                                    <td class="auto-style122"><strong>
                                        <asp:CheckBox ID="extend" runat="server" CssClass="auto-style280" Text="Extend" />
                                        </strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class="auto-style122">Final amount (+/-) 最终金额 (+/-)&nbsp; <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="famnt" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style122" colspan="4">
                                        <asp:TextBox ID="famnt" runat="server" CssClass="auto-style214" Height="24px" style="font-family: Calibri; font-size: small" Width="150px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table class="nav-justified">
                                ...
                                <tr>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style307">
                                                    <asp:CheckBox ID="empn" runat="server" CssClass="auto-style165" />
                                                </td>
                                                <em>
                                                ...
                                                <td class="auto-style307">
                                                    <asp:CheckBox ID="empd" runat="server" CssClass="auto-style165" />
                                                </td>
                                            ...
                                            <tr>
                                                <td class="auto-style231">
                                                    <asp:CheckBox ID="ldrn" runat="server" CssClass="auto-style165" />
                                                </td>
                                    ...
                                    <td class="auto-style227">
                                        <asp:TextBox ID="remark1" runat="server" CssClass="auto-style214" Height="24px" style="font-family: Calibri; font-size: small" Width="150px"  TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style227">
                                        <asp:TextBox ID="remark2" runat="server" CssClass="auto-style214" Height="24px" style="font-family: Calibri; font-size: small" Width="150px" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                    <td class="auto-style209"><span class="auto-style289">
                                ...
                                <tr>
                                    <td class="auto-style285">By Section Head
                                        ...
                                        課長</span><em></em></td>
                                    <td class="auto-style227">
                                        <asp:TextBox ID="remark3" runat="server" CssClass="auto-style214" Height="24px" style="font-family: Calibri; font-size: small" Width="150px" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                    <td class="auto-style209"><span class="auto-style289">
                            ...
                            <table class="nav-justified">
                                <tr>
                                    <td class="auto-style117"><span class="auto-style280">Same as </span><em>
                                        <asp:CheckBox ID="sameas" runat="server" CssClass="auto-style280" />
                                        </em><span class="auto-style280">一樣 </span></td>
                                    <td class="auto-style117"><span class="auto-style280">Salary Increase </span><em>
                                        <asp:CheckBox ID="sincrease" runat="server" CssClass="auto-style280" />
                ...
                <table border="1" class="auto-style169">
                    ...
                    <tr>
                        <td class="auto-style173" colspan="2" style="font-size:small">&nbsp;<asp:Label ID="Label32" runat="server" Text="Label"></asp:Label>
                        </td>
                        <td class="auto-style331" colspan="2">
                            <asp:Label ID="Label33" runat="server" Text="Time :"></asp:Label>
                            &nbsp;
