<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CS1.aspx.vb" Inherits="Performance_Management_System._0386CS1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表 Calendering Supervisor 上膠主管</td>
                                        </em>
                                    ...
                                    <td class="auto-style284" colspan="2" rowspan="2">
                                        <table class="auto-style328">
                                            <tr>
                                                ...
                                                <td class="auto-style122">Raw materials (Rubber and Fabric) 原材料 (膠料和原紗)<em>
                                            ...
                                            <tr>
                                                <td class="auto-style122"> <em>
                                                    Semi-product (PLY and Chafer) 半製品 (簾布和防擦布)<asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="TextBox1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                        </table>
                                    </td>
                ...
                <tr>
                    <td class="auto-style280">
                        <table class="nav-justified">
                            ...
                            <tr>
                                <td class="auto-style137">1. Section Head <em>
