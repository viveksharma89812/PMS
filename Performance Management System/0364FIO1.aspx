...
<%@ Page Title="" Language="vb" EnableEventValidation="false" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0364FIO1.aspx.vb" Inherits="Performance_Management_System._0364FIO1" %>
    ...
    <div class="camera-container">
      ...
      <div id="printableContent">
          ...
          <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" EnableViewState="true" Width="920px" BackColor="#ffffff" CssClass="auto-style99">
            ...
            <table id="1" border="1" class="auto-style21" style="visibility: visible; width:915px; list-style-type: circle; table-layout: fixed; border-collapse: separate; border-spacing: inherit;text-align:center; border-collapse: collapse;font-size:large" >
                <tr>
                    <td class="auto-style31" colspan="6" style="font-size:large; font-style: oblique; font-weight:bold ">
                       
                            Training / Probation Period During Review Form (For operator) 訓練期/試用期期間評核表</td>
                </tr>
                <tr> 
            ...
            <table id="2" border="1" class="auto-style20" style="width:100%; text-align:center; border-collapse: collapse;" >
                <tr>
                    ...
                    <td class="auto-style43" style="font-weight:bold;background-color:#eea236">10%</td>
                </tr>
                <tr>
            ...
            <table id="tb1" runat="server" border="1" class="auto-style20" style="width:100%; text-align:center; border-collapse: collapse;font-size:large" >
                ...
                <tr>
                    ...
                    <td class="auto-style56">15</td>
                    <td class="auto-style95">12</td>
                    <td class="auto-style96">9</td>
                    <td class="auto-style97">6</td>
                    <td class="auto-style59">3</td>
                </tr>
                <tr itemid="1">
           ...
           <table class="auto-style20" border="1" style="width:100%;  border-collapse: collapse;font-size:large;height:13%">
            ...
            <table id="3" border="1" class="auto-style114"  style="width:100%; text-align:center; border-collapse: collapse;font-size:large;" >
             <tr>
                 ...
                 <tr>
                 <td  rowspan="3" style="text-align:left; width:500px; font-size:large"  >1. Part A & B provided by HR Dept. A及B部分由人資提供<br /><br /> 2. Review employees&#39; performance in this period and give feedback or guidance in point 7. 評核該區間之表現並給予回饋。<br /><br /> 3. Fail definition: 不適任說明：<br /> Training: 訓練期 
...
<label id="lblEmpDate" runat="server"></label>
                      <asp:CheckBox ID="ch3" runat="server" AutoPostBack="true"  CssClass="emps" style="display:none" onclick="if(!confirm('Are you sure you want to Accept?'))return false;" />
                     </td>
