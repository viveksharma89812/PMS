<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386QPS2.aspx.vb" Inherits="Performance_Management_System._0386QPS2" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)PDI Shift Supervisor <br />領導/主管/一般員工績效考核表  僅適用於 第二級      </td>
                                        </em>
                            ...
                            <table class="nav-justified" style="width:100%; border-collapse: collapse;">
                                <tr>
                                    <td class="auto-style122">
                                        <table class="nav-justified" border="1" style="width:100%;  border-collapse: collapse;font-size:large">
                                            <tr>
                               ...
                               <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse;font-size:large">
                                ...
                                <tr>
                                    <td class="auto-style284">
                                        2.Work Achievement as per production planning <br />按生產計劃完成工作成果</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
