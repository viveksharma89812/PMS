<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CA1.aspx.vb" Inherits="Performance_Management_System._0386CA1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)  Curing Assistant 領導/主管/一般員工績效考核表僅適用於 第二級</td>
                                        </em>
                              ...
                              <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse;font-size:large">
                                        ...
                                        <table class="nav-justified">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score2" TabIndex="2" AutoPostBack="True" runat="server" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                                </em>
                                            </tr>
                                        </table>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score5" runat="server" AutoPostBack="True" TabIndex="5" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style320">Shift 班別 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="score3" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                </tr>
                                <tr>
                                    <td class="auto-style284" colspan="2">
                                       2. Achievement rate 生產達成率
                                    </td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score3" runat="server" AutoPostBack="True" TabIndex="3" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style130"><em>&nbsp;</em>5.Observation Skill, Detailed feedback to supervisors, Shift start/close meeting communication （觀察技巧，給主管的詳細反饋，輪班開始/結束會議溝通）<em>
                                    ...
                                    <td class="auto-style129">
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score6" AutoPostBack="True" runat="server" TabIndex="6" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">3. Defective Rate/ Scrap Rate 不良率<span class="auto-style289"> 
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score4" AutoPostBack="True" runat="server" TabIndex="4" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    <td class="auto-style130">6.Kizen Proposals to improve (提案改善)<em><asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="score7" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score7" AutoPostBack="True" runat="server" TabIndex="7" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                ...
                <tr>
                    <td class="auto-style280">
                      <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse;height:10%;font-size:large">
                            <tr>
                                ...
                                <td class="auto-style314" style="background-color: #FFD966; text-align:center"><strong>8%</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style325" rowspan="2">
                                    <asp:TextBox ID="ldr" runat="server"  placeholder="Leader Name" CssClass="auto-style165" Width="244px" TabIndex="12" MaxLength="25" style="text-align: center" Height="100%"></asp:TextBox>
                                </td>
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score8" AutoPostBack="True" runat="server"  style="text-align: center" CssClass="auto-style165" TabIndex="8" Width="70px" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em>
                                ...
                                <td class="auto-style122">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style293">4%</td>
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score9" AutoPostBack="True" runat="server"  style="text-align: center" CssClass="auto-style165" TabIndex="9" Width="70px" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em>                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="dhead" runat="server" placeholder="Dept Head Name" style="text-align: center" CssClass="auto-style165" Width="244px" TabIndex="11"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <em>
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score10" AutoPostBack="True" runat="server"   style="text-align: center" CssClass="auto-style165" TabIndex="10" Width="100%" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em>     
                  ...
                  <table id="Table1" runat="server" border="1" class="auto-style20"  style="width:100%;  border-collapse: collapse;">
                   ...
                   <table id="tb1" runat="server" border="1" class="auto-style20"  style="width:100%;  border-collapse: collapse;height:10%;font-size:large">
                            <tr>
                                <td class="text-center" style="width:150px;font-size:x-large"><strong>Recommendation &amp; Summaries the overall performance and progress 建議和總結該員整體表現</strong></td>
