<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386EST1.aspx.vb" Inherits="Performance_Management_System._0386EST11" %>
...
<%--</script>--%>
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表 Office staff辦公室人員</td>
                                        </em>
                                        ...
                                        <table class="nav-justified">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style122" colspan="3">Year : <em>
                                                    <asp:Label ID="ReviewMonth" runat="server" CssClass="auto-style280" Text="Label"></asp:Label>
                                                    &nbsp; &nbsp;</em><asp:CheckBox ID="CheckBox38" runat="server" CssClass="auto-style280" Text="Q1" />
                            ...
                            <table class="nav-justified">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2" colspan="2">
                                        2Document and SAP control 文件和SAP管控</td>
                                    <td class="auto-style129" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                        ...
                        <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                ...
                <center>
                <asp:Button ID="Button1" runat="server" cssclass="btn btn-primary" style="font-family: call; font-size: small;" Text="Submit" ValidationGroup="insert" />
                <span class="auto-style184"><%--<asp:Button ID="Button2" runat="server" CssClass="auto-style102" Height="43px" Text="Export To PDF" />--%></span>
      </center>
                <em><em></td>
                </tr>
