<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386TA1.aspx.vb" Inherits="Performance_Management_System._0386TA1" %>
    ...
    <div class="camera-container">
        ...
        <!-- Webcam Container -->
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)Building assistant 領導/主管/一般員工績效考核表 僅適用於 第二級  </td>
                                        </em>
           ...
           <table id="2" border="1" class="auto-style20" style="width:100%; border-collapse: collapse;">
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score1" runat="server" CssClass="auto-style165" AutoPostBack="True" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score5" runat="server" CssClass="auto-style165" AutoPostBack="True" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style330">
                                                    <asp:TextBox ID="score6" runat="server" CssClass="auto-style165" AutoPostBack="True" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score2" runat="server" CssClass="auto-style165" AutoPostBack="True" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style330">
                                                    <asp:TextBox ID="score7" runat="server" CssClass="auto-style165" AutoPostBack="True" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score3" runat="server" CssClass="auto-style165" AutoPostBack="True" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style326">
                                                    <asp:TextBox ID="score8" runat="server" CssClass="auto-style165" AutoPostBack="True" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score4" runat="server" CssClass="auto-style165" AutoPostBack="True" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                ...
                <tr>
                    <td class="auto-style280">
                                  <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse;height:10%; font-size:large">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138" rowspan="2">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" Height="40px"></asp:TextBox>
                                </td>
                                <td class="auto-style303" rowspan="2">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304">
                                                <asp:TextBox ID="score10" runat="server" AutoPostBack="True" CssClass="auto-style165" TabIndex="8" Width="70px" ></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score11" runat="server" AutoPostBack="True" CssClass="auto-style165" Width="244px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                ...
                <table id="tb1" runat="server" border="1" class="auto-style20"  style="width:100%;  border-collapse: collapse;height:10%;font-size:large">
                            <tr>
                                ...
                                <td class="auto-style83">
                                    <asp:TextBox ID="remark" runat="server" BackColor="White" BorderColor="White" BorderStyle="None" cssclass="form-control" Height="70px" TabIndex="16"  style="width:100%;font-size:x-large; height:100%" TextMode="MultiLine"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                      <table border="1" class="auto-style169"  style="width:100%; text-align:center; border-collapse: collapse;font-size:large">
                            <tr>
                                <td class="auto-style331" rowspan="2" style="background-color:#eea236"><strong>Remarks 評論</strong></td>
                                <td class="auto-style175" rowspan="3" style="background-color:#eea236"><strong>Total Score<br /> &nbsp;總得分<br /> &nbsp;100%</strong></td>
