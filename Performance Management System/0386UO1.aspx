<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386UO1.aspx.vb" Inherits="Performance_Management_System._0386UO1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) Operation team 績效評核_可變薪酬評核表-僅適用於第三級作業職 </td>
                                        </em>
                            ...
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style133" rowspan="6">
                                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                            <tr>
                                                <td class="auto-style122" rowspan="2"><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />Material/Equipment Management<br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /></td>
