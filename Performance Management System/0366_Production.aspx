<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0366_Production.aspx.vb" Inherits="Performance_Management_System.WebForm24" %>
...
<center><asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="882px" BackColor="#ffffff">
        <table class="auto-style3" border="1">
            <tr>
                <td colspan="6" style=" font-style: oblique; font-weight:bold" onclick="return false"><asp:CheckBox ID="c1" runat="server"></asp:CheckBox> Training / <asp:CheckBox ID="c2" runat="server"></asp:CheckBox> Probation Period Review Form (For Production Operator)訓練期/試用期評核表(作業人員)</td>
            </tr>
            <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="score2" runat="server"></asp:TextBox>
            </td>
        </tr>
            <tr>
        ...
        <tr>
            ...
            <td class="auto-style25">30%</td>
            <td>
                <asp:TextBox ID="score3" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
