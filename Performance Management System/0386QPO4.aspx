<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386QPO4.aspx.vb" Inherits="Performance_Management_System._0386QPO4" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) PDI Inspection 績效評核_可變薪酬評核表-僅適用於第三級作業職</td>
                                        </em>
                                    ...
                                    <td class="auto-style284">
                                        <table class="auto-style326">
                                            <tr>
                                                ...
                                                <td class="auto-style122"><em> Outflow Control/Customer Complaint 不良流出/客訴 <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="score2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                        </table>
                                    </td>
