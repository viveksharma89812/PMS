 <%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386S1.aspx.vb" Inherits="Performance_Management_System._0386S1" %>
    ...
    <div class="camera-container">
      ...
      <div id="printableContent">
          <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid" EnableViewState="true" Width="920px" BackColor="#ffffff" CssClass="auto-style99">
            ...
            <table id="1" border="1" class="auto-style21" style="visibility: visible;  list-style-type: circle; table-layout: fixed; border-collapse: separate; border-spacing: inherit ;width:100%; text-align:center; border-collapse: collapse;font-size:large"">
                <tr>
                    <td class="auto-style31" colspan="6" style="font-size:large;text-align:center; font-style: oblique; font-weight:bold ">
                     
                               Training_Probation Period During Review Form (For Staff)  培訓_試用期考核表（員工適用）
                </tr>
                <tr>
