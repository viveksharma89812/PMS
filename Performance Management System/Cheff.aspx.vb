...
Public Class Cheff
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If dt1 IsNot Nothing AndAlso dt1.Rows.Count > 0 Then
                ...
                Attendenancescore.InnerText = Convert.ToString(dt1.Rows(0)("LeavesScores"))
    ...
    Public Sub up()
        ...
        If ch1.Checked = True Then
            result()
            strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='DONE',Form_ID='84',Dept_Accept='" & deptaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
    ...
    Private Sub result()
        ...
        Else
            ...
            totmarks.InnerText = Gtot
            If score1.Text <> "" And score2.Text <> "" And score3.Text <> "" And score4.Text <> "" Then
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles insert.Click
        ...
        Try
            ...
            If ch2.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='PENDING',Form_ID='84',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
                If sqlexe(constr, strsql) Then
                End If
            End If
            If ch1.Checked = True And ch2.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='DONE',Form_ID='84',Dept_Accept='" & deptaccept & "',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
                If sqlexe(constr, strsql) Then
                End If
            End If
