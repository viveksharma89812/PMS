<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0399_Production.aspx.vb" Inherits="Performance_Management_System.WebForm34" %>
    ...
    <center><asp:Label ID="Label4" runat="server" ForeColor="Red" Text="Label" Visible="False"></asp:Label>
        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="892px" BackColor="#ffffff">
            ...
            <table style="width:100%" border="1">
                <tr>
                    <td colspan="10" style="font-weight:bold">
                        Permanent Period Review Form (For Production Operator)</td>
                </tr>
                 <tr>
                      <td colspan="7" style="font-weight:bold;background-color:#eea236">A. Employee Information(By HR)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                     <td colspan="3" style="font-weight:bold; background-color:#eea236">&nbsp;
            ...
            <table border="1" style="width:100%">
                <tr>
                    <td class="auto-style63" style="background-color:#eea236">Remarks</td>
                    ...
                    <td class="auto-style62" style="font-weight:bold">
                ...
                <tr>
                    <td class="auto-style63" rowspan="3" style="text-align:left; font-size:small">Performance status definition :考核結果說明 <br /> 1.Pass: Score is 76 or more than 76 every time<br /> &nbsp;適任: 分數高於76分 
                        <br />
