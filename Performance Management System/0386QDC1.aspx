<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386QDC1.aspx.vb" Inherits="Performance_Management_System._0386QDC1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2) DCC   <br />    領導/主管/一般員工績效考核表   僅適用於 第二階層           </td>
                                        </em>
                        ...
                        <td class="auto-style280">
                              <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse;">
                                 <tr style="background-color: #D9E1F2; text-align:center">
                                    ...
                                    <td class="auto-style132"><strong>16%</strong></td>
                                </tr>
                               ...
                               <tr>
                                  ...
                                  <tr>
                                    <td class="auto-style284"  colspan="2">2. Inprocess Abnormity monitoring & their closures 進程內異常監控及其關閉 </td>
                                    ...
                                    <td class="auto-style130" rowspan="2">8.Employee Behaviour  (員工行為)</td>
                                ...
                                <tr>
                                    <td class="auto-style284"  colspan="2">3. Timely submission of documents to QA DCC & maintain scan copies 及時向QA DCC提交文件並保留掃描件</td>
                                    <td class="auto-style129"  colspan="1"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">15%</td>
                                 ...
                                 <tr>
                                   ...
                                   <tr>
                                    <td class="auto-style284"  colspan="2">5.Timely Submission of C.S.T.G Policy data & other documents work(Plan vs Actual) 及時提交C.S.T.G政策數據和其他文件工作（計劃與實際）</td>
                                    <td class="auto-style129"  colspan="1"><em>
                                        <table class="nav-justified">
                                            <tr>
                                    ...
                                    <td class="auto-style130" rowspan="2">10.Self Initiative approach(自我主動的方法) </td>
                                    <td class="auto-style129" rowspan="2"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">4%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score10" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align:center" TabIndex="6" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284"  colspan="2">6.Continuous Improvement (Monthly Kaizen submissions) 持續改進（每月改善提交）</td>
                                    <td class="auto-style129"  colspan="1"><em>
                                        <table class="nav-justified">
                                            <tr>
                   ...
                   <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse;">
                           ...
                           <tr>
                                ...
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style327">4<em>%</span></em></td>
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score11" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align:center" TabIndex="12" Width="122px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style327">4<em>%</span></em></td>
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score12" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center" TabIndex="13"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score13" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True" TabIndex="14" ></asp:TextBox>
                                </td>
                            </tr>
                        </table>
