...
Public Class _0386EOS1
    ...
    Public Sub up()
        ...
        If ch1.Checked = True Then
            result()
            strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',Score6='" & score6.Text & "',Score7='" & score7.Text & "', Score8='" & score8.Text & "' , Score9='" & score9.Text & "', TotalMarks='" & totmarks.Text & "',Status='" & status & "',Form_Status='DONE',Form_ID='51',Dept_Accept='" & deptaccept & "' ,Ldr ='" & ldr.Text & "', Shead = '" & shead.Text & "', Dhead = '" & dhead.Text & "' , Remark4 = '" & remark.Text & "'  where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
    ...
    Protected Sub insert_Click(sender As Object, e As EventArgs) Handles insert.Click
        Try
            ...
            End If
            If ch1.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',Score6='" & score6.Text & "',Score7='" & score7.Text & "', Score8='" & score8.Text & "' , Score9='" & score9.Text & "', TotalMarks='" & totmarks.Text & "',Status='" & status & "',Form_Status='DONE',Form_ID='51',Ldr ='" & ldr.Text & "',Dept_Accept='" & deptaccept & "' , Shead = '" & shead.Text & "', Dhead = '" & dhead.Text & "' , Remark4 = '" & remark.Text & "'  where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
            ...
            If ch2.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',Score6='" & score6.Text & "',Score7='" & score7.Text & "', Score8='" & score8.Text & "' , Score9='" & score9.Text & "', TotalMarks='" & totmarks.Text & "',Status='" & status & "',Form_Status='PENDING',Form_ID='51',Ldr ='" & ldr.Text & "',Sect_Accept='" & sectaccept & "', Shead = '" & shead.Text & "', Dhead = '" & dhead.Text & "' , Remark4 = '" & remark.Text & "'  where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"

                If sqlexe(constr, strsql) Then
                End If
            End If
            If ch1.Checked = True And ch2.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',Score6='" & score6.Text & "',Score7='" & score7.Text & "', Score8='" & score8.Text & "' , Score9='" & score9.Text & "', TotalMarks='" & totmarks.Text & "',Status='" & status & "',Form_Status='DONE',Form_ID='51',Ldr ='" & ldr.Text & "',Dept_Accept='" & deptaccept & "',Sect_Accept='" & sectaccept & "' , Shead = '" & shead.Text & "', Dhead = '" & dhead.Text & "'  , Remark4 = '" & remark.Text & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
