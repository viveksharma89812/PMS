<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0367_Rd2_Mold.aspx.vb" Inherits="Performance_Management_System.WebForm31" %>
            ...
            <table style="width:100%" border="1">
                <tr>
                    <td colspan="10" style="font-weight:bold" onclick="return false">
                        ...
                        Probation Period Review Form (For RD2 Mold Operator)訓練期/試用期評核表(作業人員)</td>
                </tr>
                 <tr>
                 ...
                 <tr>
                     ...
                     <td colspan="2" class="auto-style47">
                      ...
                      <td class="auto-style63" >Employee Code</td>
                     <td>
