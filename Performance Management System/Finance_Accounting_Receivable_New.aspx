<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Finance_Accounting_Receivable_New.aspx.vb" Inherits="Performance_Management_System.Finance_Accounting_Receivable_New" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified"  style="width:100%; border-collapse: collapse;">
                                    <tr>
                                        <td class="auto-style114">  Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)


<u style="color:red"><span style="color:red; ">   Finance Accounting-Receivable  </span></u><br /> 領導/主管/員工績效考核表（限二級）財務會計-應收帳款</td>
                                        </em>
                                    </tr>
                                </table>
                            </center>
                    ...
                    <tr>
                        <td class="auto-style31" style="font-weight:bold">
                            <center class="auto-style68" style="background-color:#FFD966 ">
                                A. Employee Information 員工基礎信息</center>
                        </td>
                    </tr>
                    </em>
                </table>
                                        ...
                                        <table class="nav-justified"  border="1"  style="width:100%; border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style122" colspan="3">Year : <em>
                                                    ...
                                                    &nbsp;&nbsp;</em><asp:CheckBox ID="CheckBox1" runat="server" CssClass="auto-style280" Text="weekly" /> &nbsp;&nbsp;<asp:CheckBox ID="month" runat="server" CssClass="auto-style280" Text="Monthly" />
                        ...
                        <td class="auto-style280">
                            ...
                            <tr style="background-color: #D9E1F2; text-align:center">
                                ...
                                <tr>
                                   ...
                                   <td class="auto-style322" rowspan="2">
                                    ...
                                    <td class="auto-style321" rowspan="2">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">
                                      2. Sales summary sheet prepare  銷售總結表準備</td>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" colspan="2">
                                    3. Duty drawback receivable  應收關稅退稅</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" colspan="2">
                                     4.Customer account ledger reco. 客戶帳戶分類帳記錄。</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <%--this is empty tr--%>
                                 <tr>
                                    <td class="auto-style284" colspan="2">
                                   5.Audit data helping  審計數據幫助</td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                ...
                <table id="tb1" runat="server" border="1" class="auto-style20" style="width:100%; border-collapse: collapse; height:15%;font-size:large">
                            <tr>
                                <td class="text-center" style="width:170px;font-size:large"><strong> Recommendation &
