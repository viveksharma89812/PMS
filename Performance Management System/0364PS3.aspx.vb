...
Public Class _0364PS3
    ...
    Public Sub up()
        ...
        If ch1.Checked = True Then
            result()
            strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',  TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='DONE',Form_ID='78',Dept_Accept='" & deptaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
    ...
    Private Sub result()
        ...
        If score5.Text <> "" And score5.Text = 1 Or score5.Text = 2 Or score5.Text = 3 Or score5.Text = 4 Or score5.Text = 5 Then
            Tot4 = Double.Parse(score5.Text) * 1
        End If
    ...
    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles insert.Click
        ...
        Try
            ...
            If ch2.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='PENDING',Form_ID='78',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
                If sqlexe(constr, strsql) Then

                End If
            End If
            If ch1.Checked = True And ch2.Checked = True Then
                strsql = "update" + " " + tot + " " + "set Score1='" & score1.Text & "',Score2='" & score2.Text & "',Score3='" & score3.Text & "',Score4='" & score4.Text & "',Score5='" & score5.Text & "',TotalMarks='" & totmarks.InnerText & "',Status='" & status & "',Remark='" & remark.Text & "',Form_Status='DONE',Form_ID='78',Dept_Accept='" & deptaccept & "',Sect_Accept='" & sectaccept & "' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
                If sqlexe(constr, strsql) Then
