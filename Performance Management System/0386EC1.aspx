<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386EC1.aspx.vb" Inherits="Performance_Management_System._0386EST1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表 CNC 口金班</td>
                                        </em>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="3">8.Proposals to improve (提案改善) <em>
                                ...
                                <tr>
                                    <td class="auto-style284">4.Fabrication of Die 口金製作</td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">15%</td>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score11" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score12" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
