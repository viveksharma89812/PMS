...
<%@ Page Title="" Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386_Chef.aspx.vb" Inherits="Performance_Management_System._0386_Chef" %>
        ...
        <asp:Panel ID="Panel1" runat="server" BorderStyle="Solid"  Width="900px" BackColor="#ffffff">
            ...
            <table id="1" border="1" class="auto-style21" style="width:895px">
                <tr>
                    <td class="auto-style31" colspan="6" style="font-size: large; font-style: oblique; font-weight:bold">
                        <center>
                            Performance review Form of Probation Period During/Final Review / Permanent Period (For Chef)</center>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style114">Dept./Section</td>
                    <td class="auto-style115" ID="deptsect" runat="server">
                        
                    </td>
                    <td class="auto-style116">DOJ</td>
                    <td class="auto-style117" ID="doj" runat="server">
                        
                    </td>
                    <td class="auto-style118">Reporting To</td>
                    <td ID="repto" runat="server" class="auto-style119">
            ...
            <table id="2" border="1" class="auto-style20">
                <tr>
                    ...
                    <td class="auto-style43" style="background-color:#eea236 ">10%</td>
                </tr>
                <tr>
            ...
            <table id="tb1" runat="server" border="1" class="auto-style20">
                ...
                <tr itemid="1">  
                    <td class="auto-style54" colspan="2" title="a" style="text-align:left"><strong>1. Behaviour:</strong> It includes Personal grooming &amp; hygiene, Always wears the proper &amp; Clean uniform and systematic behaviour with staff Members &amp; Customers..<asp:TextBox ID="scor1" runat="server" Visible="False"></asp:TextBox>
                    </td>
                    <td class="auto-style105" title="a">20<asp:CustomValidator ID="CustomValidator1" ValidationGroup="insert" runat="server" ErrorMessage="select at least one item." Text="*" ForeColor="Red" ClientValidationFunction="ValidateCheckBoxList"></asp:CustomValidator></td>
                ...
                <tr>
                    <td class="auto-style54" colspan="2" style="text-align:left"><strong>2. Customers: </strong>It involves the customer satisfaction in respect of food test and food presentation , it also covers the views of customers.<asp:TextBox ID="scor2" runat="server" Visible="False"></asp:TextBox>
                    </td>
                    <td class="auto-style105">25<asp:CustomValidator ID="CustomValidator2" ValidationGroup="insert"  runat="server" ErrorMessage="select at least one item." Text="*" ForeColor="Red" ClientValidationFunction="ValidateCheckBoxList1"></asp:CustomValidator></td>
                    <td colspan="5">
                ...
                <tr>
                    <td class="auto-style54" colspan="2" style="text-align:left"><strong>3. Cost Management:</strong> It covers the budget of kitchen. Also ordering of food and production, holding &amp; presentation of food.<asp:TextBox ID="scor3" runat="server" Visible="False"></asp:TextBox>
                    </td>
                    <td class="auto-style105">25<asp:CustomValidator ID="CustomValidator3" ValidationGroup="insert" runat="server" ErrorMessage="select at least one item." Text="*" ForeColor="Red" ClientValidationFunction="ValidateCheckBoxList2"></asp:CustomValidator></td>
                    <td colspan="5">
                ...
                <tr>
                    <td class="auto-style54" colspan="2" style="text-align:left"><strong>4. CLOSING:</strong> Properly closes station including cleaning, FIFO, Label &amp; Dating, equipment maintenance..<asp:TextBox ID="scor4" runat="server" Visible="False"></asp:TextBox>
                    </td>
                    <td class="auto-style105">20<asp:CustomValidator ID="CustomValidator4" ValidationGroup="insert" runat="server" ErrorMessage="select at least one item." Text="*" ForeColor="Red" ClientValidationFunction="ValidateCheckBoxList3"></asp:CustomValidator></td>
                    <td colspan="5">
                ...
                <tr>
                    <td  style="text-align:left;width:150px">5. Summarise the overall performance or comment : 總評建議:</td>
