<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386CL2.aspx.vb" Inherits="Performance_Management_System._0386CL2" %>
    ...
    <div class="camera-container">
        ...
        <!-- Webcam Container -->
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)  Cutting Leader <br /> 領導/主管/一般員工績效考核表   僅適用於 第二級      </td>
                                        </em>
                ...
                <table id="2" class="auto-style20"  style="width:100%;">
                    <tr>
                    ...
                    <tr  style="width:100%; text-align:center; border:1px; border-collapse: collapse;">
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score5" runat="server"  AutoPostBack="True" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style321">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score6" runat="server" AutoPostBack="True"  CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2" rowspan="2">
                                        <table class="auto-style328">
                                            <tr>
                                                <td class="auto-style325">2.Defective Rate/ Scrap Rate 不良率/報廢率</td>
                                                <td class="auto-style122"><em>
                                                    &nbsp;Raw materials (Rubber and Steel cord). Semi-product(PLY, Chafer, BW, and BF) 原材料 (膠料和鋼絲)、半製品 (簾布、防擦布、鋼絲圈和三角膠)
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score4"  runat="server" AutoPostBack="True" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    <td class="auto-style130">8.Proposals to improve (提案改善)</td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
                                                <td class="auto-style326">
                                                    <asp:TextBox ID="score9"  runat="server" AutoPostBack="True" CssClass="auto-style165" Width="70px"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                ...
                <tr>
                    ...
                    <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse; font-size:large; height:10%">
                            ...
                            <tr  style="background-color: #FFD966; text-align:center">
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score12" runat="server"    style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="14"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
