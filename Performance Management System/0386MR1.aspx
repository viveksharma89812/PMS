                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表 Repair Engineer 維修人員</td>
                                        </em>
                                        <td class="auto-style323">
                                            <asp:CheckBox ID="supldr" runat="server" Font-Size="Medium" Text="Supervisior / Leader" />
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified">
                                ...
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
