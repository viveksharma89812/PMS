<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386MR1.aspx.vb" Inherits="Performance_Management_System._0386MR1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) Repair Engineer 績效評核_可變薪酬評核表-僅適用於第三級作業職</td>
                                        </em>
                                        <td class="auto-style323">
                                            <asp:CheckBox ID="supldr" runat="server" Font-Size="Medium" Text="Supervisior / Leader" Visible="False" />
                    ...
                    <tr>
                        <td class="auto-style280">
                            <table  class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="3">
                                        <table  class="nav-justified" style="width:100%; border-collapse: collapse; text-align:center" border="1">
                                            <tr>
                                                <td class="auto-style122" rowspan="3">2. Repair completion rate維修達成率 </td>
                                                <td class="auto-style122">Repair Achievement Rate in site 立即維修達成率</td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style122">Achievement rate of return maintenance回設服維修達成率</td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style122">Out-of-factory repair and parts-to-factory tracking 廠外維修與零件到廠追蹤</td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style129">
                                    ...
                                    <td class="auto-style130" rowspan="4"><em>5.Matters assigned by superiors上級交辦事項 <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="score7" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284">3. Level 1 maintenance check achievement rate 一級保養查核達成率<span class="auto-style289"><asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="score5" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                ...
                <tr>
                    <td class="auto-style280">
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                            ...
                            <tr>
                                <td class="auto-style328">1.Leader</td>
                                ...
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center" TabIndex="9"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="10"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                            ...
                            <table  class="nav-justified"  border="1" style="width:100%; border-collapse: collapse; text-align:center;">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style122" colspan="4">
                                        <asp:TextBox ID="famnt" runat="server" AutoPostBack="True" CssClass="auto-style214" Height="24px" style="font-family: Calibri; font-size: small; text-align: center;" Width="150px"></asp:TextBox>
