...
Public Class WebForm26
    ...
    End Sub
    Private Sub result()
        Dim Tot, Tot1, Tot2, Gtot As Double
        ...
        Gtot = Tot + Tot1 + Tot2
        If score.Text <> "" And score2.Text <> "" Then
    ...
    Protected Sub insert_Click(sender As Object, e As EventArgs) Handles insert.Click
        Try
            ...
            strsql = "update" + " " + tot + " " + "set Score1='" & marks & "',Score2='" & score2.Text & "',TotalMarks='" & totscore.InnerText & "',Remark='" & remark.Text & "',Form_Status='DONE',Form_ID='10' where EmployeeCode='" & Session("empl code") & "' and ReviewMonth='" & tyear & "'"
