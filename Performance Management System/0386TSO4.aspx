<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master"  CodeBehind="0386TSO4.aspx.vb" Inherits="Performance_Management_System._0386TSO4" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) TB -Spraying OP 績效評核_可變薪酬評核表-僅適用於第三級作業職 </td>
                                        </em>
                                        ...
                                        <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style122" colspan="3">Year : <em>
                                                    <asp:Label ID="revmonth" runat="server" CssClass="auto-style280"></asp:Label>
                                                    &nbsp;
                                                    </em>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score3" runat="server" CssClass="auto-style165" Width="70px" style="text-align:center" AutoPostBack="True" TabIndex="3"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score5" runat="server" CssClass="auto-style165" Width="70px" style="text-align:center" AutoPostBack="True" TabIndex="5"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                ...
                                <td class="auto-style122">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style293">4%</td>
                                            <td class="auto-style304">
                                                <asp:TextBox ID="score9" runat="server" AutoPostBack="True" CssClass="auto-style165" Width="70px" TabIndex="9"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    </em>
