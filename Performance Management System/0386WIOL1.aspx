<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386WIOL1.aspx.vb" Inherits="Performance_Management_System._0386WIOL1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <%--<Triggers><asp:PostBackTrigger ControlID="Button2" /></Triggers>--%><ContentTemplate>
            <center>
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2) Inward/Outward <br />  領導/主管/一般員工績效考核表 僅適用於 第二級     </td>
                                        </em>
                        ...
                        <td class="auto-style280">
                               <table class="nav-justified" border="1" style="width:100%; text-align:center; border-collapse: collapse;">
                                 ...
                                 <td class="auto-style134" colspan="2"><strong>B. Fixed固定的</strong></td>
                                    ...
                                    <td class="auto-style132"><strong>15%</strong></td>
                                </tr>
                                <tr>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score1" runat="server" AutoPostBack="True"  CssClass="auto-style165" Width="70px" TabIndex="1"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style311" rowspan="3">5<span class="auto-style289">. Work Attitude 工作態度 <em>
                                    ...
                                    <td class="auto-style310"  rowspan="3">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score7" runat="server"  AutoPostBack="True" CssClass="auto-style165" Width="70px" TabIndex="7"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style321">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score2" runat="server" AutoPostBack="True"  CssClass="auto-style165" Width="70px" TabIndex="2"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style284"  colspan="2">2.Work Achievement Rate /Shopfloor Documentation/Warehouse layout handling  <br />工作完成率/車間文件/倉庫佈局處理   </td>
                                ...
                                <tr>
                                    <td class="auto-style284" rowspan="2">3. Defect outflow/Work area condition 缺陷流出/工作區域狀況</td>
                                    <td class="auto-style309">Outflow Control/Customer Complaint/Abnormal things found 流出控制/客戶投訴/發現異常情況<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="score1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                    <td class="auto-style310">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">40%</td>
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score4" runat="server" AutoPostBack="True"  CssClass="auto-style165" Width="70px" TabIndex="4"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style311" rowspan="3">6<span class="auto-style289">.Employee Behaviour and Team Work 員工行為與團隊合作 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="score5" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                    <td class="auto-style310"  rowspan="3">
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style320">5'S at work Place/Safety at work place 工作場所 5'S/工作場所安全 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="score2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style321">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score5" runat="server" AutoPostBack="True"  CssClass="auto-style165" Width="70px" TabIndex="5"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style284"  colspan="2">4. Continuous learning/ improvements in the existing process  持續學習/提案改善</td>
                                    <td class="auto-style129"  colspan="1"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</td>
                ...
                <tr>
                      ...
                      <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="Ldrd" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="15"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style327">3<em>%</span></em></td>
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score9" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align:center" TabIndex="13" Width="122px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                           ...
                           <tr>
                                <td class="auto-style291">
                                    2.Leader</td>
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="14"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style327">3<em>%</span></em></td>
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score10" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align:center" TabIndex="10" Width="122px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td class="auto-style291">3. Section Head</td>
                                <td class="auto-style138">
                                    <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="15"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style327">3<em>%</span></em></td>
                                            <td class="auto-style303">
                                                <asp:TextBox ID="score11" runat="server" CssClass="auto-style165" Width="122px" AutoPostBack="True" style="text-align:center" TabIndex="11"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="dhead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="16"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:TextBox ID="score12" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True" TabIndex="12" ></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                 ...
                 <table id="Table1" runat="server" border="1" class="auto-style20"  style="width:100%;  border-collapse: collapse;">
                   ...
                   <table id="tb1" runat="server" border="1" class="auto-style20"  style="width:100%;  border-collapse: collapse;">
                            <tr>
                                <td class="text-center" style="width:150px"><strong>Recommendation &amp; Summaries the overall performance and progress 建議和總結該員整體表現</strong></td>
                                <td class="auto-style83">
                                    <asp:TextBox ID="remark" placeholder="Remark here.." runat="server" BackColor="White" BorderColor="White" BorderStyle="None" cssclass="form-control" Height="70px" TextMode="MultiLine" TabIndex="16"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <table border="1" class="auto-style169"  style="width:100%; text-align:center; border-collapse: collapse;">
                            <tr>
