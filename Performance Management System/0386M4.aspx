<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386M4.aspx.vb" Inherits="Performance_Management_System._0386M4" %>
...
<div id="outerimgdiv" style="position:fixed;" runat="server">
   ...
   <div id="printableContent">
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#ffffff" BorderStyle="Solid" CssClass="auto-style183" Width="900px">
                                ...
                                <table class="nav-justified">
                                    <tr>
                                        ...
                                        <td class="auto-style323">
                                            ...
                                            &nbsp;<asp:CheckBox ID="CheckBox2" runat="server" Font-Size="Medium" Text="OP" Enabled="False" />
                                        </td>
                                    </tr>
                                </table>
                            </center>
               ...
               <table id="2"  class="auto-style20" style="width:100%; border-collapse: collapse;">
                    ...
                    <tr>
                        <td class="auto-style280">
                            <table class="nav-justified" border="1" style="width:100%; border-collapse: collapse; ">
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2"><em>4<span class="auto-style289">.Document control 文件管控 
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="score4" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></em></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                ...
                <tr>
                    <td class="auto-style280">
                         <table class="nav-justified" border="1" style="width:100%; border-collapse: collapse; text-align:center; height:15%">
                            <tr>
                            ...
                            <tr style="font-size:large">
                                <td class="auto-style137">1. Leader <em>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="score9" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </em></td>
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" MaxLength="25" style="text-align: center" TabIndex="13"></asp:TextBox>
                                </td>
                                <td class="auto-style303">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304">
                                                <asp:TextBox ID="score9" runat="server" AutoPostBack="True" CssClass="auto-style165" style="text-align: center" Height="21px" TabIndex="9" Width="70px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" style="text-align: center" Width="244px" AutoPostBack="True" TabIndex="10"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score11" runat="server" CssClass="auto-style165" style="text-align: center" Width="244px" AutoPostBack="True" TabIndex="11"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
  ...
  <asp:TextBox ID="remark" runat="server" BackColor="White" BorderColor="White" BorderStyle="None"
    ...
    onkeyup="checkLength();"></asp:TextBox>                                </td>
                        ...
                        <table border="1" class="auto-style169" style="width:100%; border-collapse: collapse; text-align:center;font-size:large;height:20%">
                            <tr>
