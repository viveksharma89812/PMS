<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386TAL3.aspx.vb" Inherits="Performance_Management_System._0386TAL3" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) Building assistant 績效評核_可變薪酬評核表-僅適用於第三級作業職</td>
                                        </em>
                                        <td class="auto-style323">
                                            <asp:CheckBox ID="supldr" runat="server" Font-Size="Medium" Text="Supervisior / Leader" AutoPostBack="True" Checked="True" Visible="False" />
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                <tr style="background-color: #D9E1F2; text-align:center">
                                    ...
                                    <td class="auto-style132">12<strong>%</strong></td>
                                </tr>
                                <tr>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score1" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="1"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style310">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">2%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score5" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="5"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style320">Shift 班別 </td>
                                    <td class="auto-style130">5. Near miss, accident, unsafe condition (nos) (未遂事件、事故、不安全狀況（否）)<span class="auto-style289"><em><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="score6" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></span></td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style329">2%</span></td>
                                                <td class="auto-style330">
                                                    <asp:TextBox ID="score6" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="6"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2" rowspan="2">
                                        <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            <tr>
                                                <td class="auto-style325" rowspan="2">2. Scrap rate 報廢率</td>
                                                <td class="auto-style122">Semi-products 半成品<em>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="score2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                            <tr>
                                                <td class="auto-style122"> Green Tire Scrap 生胎報廢<em>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="score3" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score2" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="2"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style130">6.Maintenance of accessories (配件維護) <em><span class="auto-style289">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="score7" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></em></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style329">4%</span></td>
                                                <td class="auto-style330">
                                                    <asp:TextBox ID="score7" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="7"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score3" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="3"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    <td class="auto-style130">7.Observation Skill, Detailed feedback to supervisors, Shift start/close meeting communication （觀察技巧，給主管的詳細反饋，輪班開始/結束會議溝通） <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="score8" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style326">
                                                    <asp:TextBox ID="score8" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="8"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">3<span class="auto-style289">.Mold change error 換模錯誤 
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="score4" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">15%</td>
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score4" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="4"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    <td class="auto-style130">8.Proposals to improve (提案改善) <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="score9" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">2%</span></td>
                                                <td class="auto-style326">
                                                    <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True" TabIndex="9"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                    ...
                    <td class="auto-style280">
                        <table  class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                            <tr>
                                ...
                                <td class="auto-style314" style="background-color: #FFD966; text-align:center">12<strong>%</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="13"></asp:TextBox>
                                </td>
                                <td class="auto-style303">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304">
                                                <asp:TextBox ID="score10" runat="server" AutoPostBack="True" CssClass="auto-style165" Width="70px" TabIndex="10"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="14"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <em>
                                    <table class="nav-justified">
                                        <tr>
                                            <td class="auto-style293">6%</td>
                                            <td class="auto-style304">
                                                <asp:TextBox ID="score11" runat="server" AutoPostBack="True" CssClass="auto-style165" Width="70px" TabIndex="11"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                    </em>
                            ...
                            <%--<tr>
                                <td class="auto-style291">3. Section Supervisior Head</td>
                                <td class="auto-style138">
                                    <asp:TextBox ID="sshead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:CheckBoxList ID="score12" runat="server" RepeatDirection="Horizontal" Width="188px" AutoPostBack="True">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="dhead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="15"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:TextBox ID="score12" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="12"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style226" rowspan="4">
                                        <table  class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            ...
                                            <tr>
                                                <td class="auto-style231">
                                                    <asp:CheckBox ID="sheadn" runat="server" CssClass="auto-style165" />
                                                </td>
                                                <td class="auto-style227"><span class="auto-style280">Same as (No deduct)</span><em><br class="auto-style286" /><span class="auto-style280">&nbsp;</span></em><span class="auto-style280">與（不扣除）相同</span></td>
                                                <td class="auto-style231">
                                            ...
                                            <tr>
                                                <td class="auto-style231">
                                                    <asp:CheckBox ID="dheadn" runat="server" CssClass="auto-style165" />
                                                </td>
                            ...
                            <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                <tr>
                                    ...
                                    <td class="auto-style117"><span class="auto-style280">Salary Increase </span><em>
                                        <asp:CheckBox ID="sincrease" runat="server" CssClass="auto-style280" onclick="if(!confirm('Are you sure salary will be Increase?'))return false;" AutoPostBack="True" />
                                        </em><span class="auto-style280">漲薪 </span></td>
                                    <td class="auto-style117"><span class="auto-style280">Salary decrease </span><em>
                                        <asp:CheckBox ID="sdecrease" runat="server" CssClass="auto-style280" onclick="if(!confirm('Are you sure salary will be Decrease?'))return false;" AutoPostBack="True" />
