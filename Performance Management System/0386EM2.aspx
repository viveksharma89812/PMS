<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="0386EM2.aspx.vb" Inherits="Performance_Management_System._0386EM2" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review  Form  for leader/Supervisor/Staff (Only for Level 2)Mechanical equipment engineer 領導/主管/一般員工績效考核表  僅適用於 第二級</td>
                                        </em>
                    ...
                    <tr>
                        <td class="auto-style280">
                            <table class="nav-justified" style="width:100%; border-collapse: collapse;">
                             ...
                             <tr style="width:100%; text-align:center; border-collapse: collapse;font-size:x-large">
  ...
  <tr><td><h3><u> Adhere to the above criteria based on your employee's supervised performance.  根據您員工的監督績效遵守上述標準</u></h3></td></tr>
    ...
    <table class="nav-justified"  border="1"  style="width:100%; text-align:center; border-collapse: collapse;font-size:large">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score5" runat="server"  AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="12" Width="70px" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em>
                                ...
                                <td class="auto-style122">
                                    ...
                                    <table class="nav-justified">
                                        <tr>
                                            ...
                                            <td class="auto-style304"><em>
                                                <asp:TextBox ID="score6" runat="server"  AutoPostBack="True" style="text-align: center" CssClass="auto-style165" TabIndex="12" Width="70px" ></asp:TextBox>
                                                </em></td>
                                        </tr>
                                    </table>
                                    </em> 
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score7" runat="server"   style="text-align: center" CssClass="auto-style165" Width="244px" AutoPostBack="True" TabIndex="14"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
