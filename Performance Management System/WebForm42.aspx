<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="WebForm42.aspx.vb" Inherits="Performance_Management_System.WebForm42" %>

<%--<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386EO1.aspx.vb" Inherits="Performance_Management_System._0386EO1" %>--%>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form 绩效考核表 Extrusion OP (TR Head Operator胎面膠頭手,TR Tail Operator胎面膠副手,IL Head Operator內面膠頭手,IL Tail Operator 內面膠副手,MM Operator備料人員)</td>
                                        </em>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score1" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score5" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score2" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score6" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score3" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129" rowspan="2"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">5%</span></td>
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score7" runat="server" CssClass="auto-style165" Width="70px" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                                    ...
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style304">
                                                    <asp:TextBox ID="score4" runat="server" CssClass="auto-style165" Width="70px" AutoCompleteType="Company" AutoPostBack="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em></td>
                        ...
                        <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style303">
                                    <asp:CheckBoxList ID="score8" runat="server" RepeatDirection="Horizontal" Width="188px" AutoPostBack="True">
                            ...
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score9" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style122">
                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                            ...
                            <table class="nav-justified">
                                <tr>
                                    <td class="auto-style117"><span class="auto-style280">Same as </span><em>
                                        <asp:CheckBox ID="sameas" runat="server" CssClass="auto-style280" AutoPostBack="True" />
                                        </em><span class="auto-style280">一樣 </span></td>
                                    <td class="auto-style117"><span class="auto-style280">Salary Increase </span><em>
                                        <asp:CheckBox ID="sincrease" runat="server" CssClass="auto-style280" AutoPostBack="True" />
                                        </em><span class="auto-style280">漲薪 </span></td>
                                    <td class="auto-style117"><span class="auto-style280">Salary decrease </span><em>
                                        <asp:CheckBox ID="sdecrease" runat="server" CssClass="auto-style280" AutoPostBack="True" />
