...
#End Region
    ...
    Protected Sub insert_Click(sender As Object, e As EventArgs) Handles insert.Click
        ...
        strsql = $" update {tot} set Sect_Accept='{sectaccept}',Emp_Accept='{emp}',Dept_Accept='{deptaccept}',Form_ID='93',Form_Status='{status}',Remark='{remark.Text}',TotalMarks='{totscrRounded}',time='{currentDateTime}'  where EmployeeCode='{Session("empl code")}' and ReviewMonth='{tyear}' "
