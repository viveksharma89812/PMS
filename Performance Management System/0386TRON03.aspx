<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386TRON03.aspx.vb" Inherits="Performance_Management_System._0386TRON03" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) RN Operator 績效評核_可變薪酬評核表-僅適用於第三級作業職 </td>
                                        </em>
                                        ...
                                        <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style122" colspan="3">Year : <em>
                                                    <asp:Label runat="server" CssClass="auto-style280" Text="Label" ID="revmonth"></asp:Label>
                                                    &nbsp;
                                                    </em>
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score6" runat="server" CssClass="auto-style165" Width="70px" style="text-align:center" TabIndex="6"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="auto-style129" rowspan="4">
                                        ...
                                        <table class="nav-justified">
                                            <tr>
                                                ...
                                                <td class="auto-style131">
                                                    <asp:TextBox ID="score7" runat="server" CssClass="auto-style165" Width="70px" style="text-align:center" AutoPostBack="True" TabIndex="7"></asp:TextBox>
                                                </td>
                                            </tr>
                                        </table>
                                        </em>
                    ...
                    <tr>
                        <td class="auto-style122" colspan="2">
                            <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                ...
                                <em>
                                <tr>
                                    <td class="auto-style327">By Section Head
                                        <br />
                                        課長</span><em></em></td>
                                    ...
                                    <td class="auto-style329"><span class="auto-style289">
