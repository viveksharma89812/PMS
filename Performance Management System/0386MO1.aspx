<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master" CodeBehind="0386MO1.aspx.vb" Inherits="Performance_Management_System._0386MO1" %>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) 績效評核_可變薪酬評核表-僅適用於第三級作業職 Welding /Lathe machine Team / hooklift Driver</td>
                                        </em>
                        ...
                        <td class="auto-style280">
                            <table  class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style130">4.Environment 5S (環境5S)<span class="auto-style289"> <em>
                                ...
                                <tr>
                                    <td class="auto-style284">
                                        <table class="nav-justified" style="width:100%; border-collapse: collapse; text-align:center" border="0">
                                            <tr>
                                                <td class="auto-style122">2. Job completion rate工作達成率 </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="auto-style129">
                                        <table class="nav-justified">
                                            <tr>
                                                <td class="auto-style293">41%</span></td>
                                                <td class="auto-style131">
                                    ...
                                    <td class="auto-style130" rowspan="2"><em>5.Matters assigned by superiors上級交辦事項 <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="score5" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                ...
                                <tr>
                                    <td class="auto-style284">3.Achievement rate of first-level maintenance of used equipment 使用設備一級保養達成率<span class="auto-style289"><asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="score3" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </span></td>
                    ...
                    <td class="auto-style280">
                        <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center;font-size:large">
                            <tr>
                                ...
                                <td class="auto-style314" colspan="2" style="background-color: #FFD966; text-align:center"><strong>9%</strong></td>
                            </tr>
                            <tr class="auto-style313" style="background-color: #FFD966; text-align:center" >
                                <td class="auto-style314" colspan="2">(0% but can change all)</td>
                            </tr>
                            <tr>
                                <td class="auto-style291">
                                    <table class="nav-justified"  border ="0" style="width:100%; border-collapse: collapse; text-align:center">
                                        <tr>
                                            <td class="auto-style327">1.Leader</td>
                                        </tr>
                                    </table>
                                </td>
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="9"></asp:TextBox>
                                </td>
                                <td class="auto-style327">4%</td>
                                <td class="auto-style327">
                                    <asp:TextBox ID="score6" runat="server" AutoPostBack="True" CssClass="auto-style165" Width="122px" style="text-align:center" TabIndex="6"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="auto-style291">2. Section Head</td>
                                <td class="auto-style138">
                                    <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="10"></asp:TextBox>
                                </td>
                                <td class="auto-style122" colspan="2">
                                    <table  class="nav-justified"  border ="0" style="width:100%; border-collapse: collapse; text-align:center">
                                        <tr>
