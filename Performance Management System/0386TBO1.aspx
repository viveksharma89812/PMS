<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master"  CodeBehind="0386TBO1.aspx.vb" Inherits="Performance_Management_System._0386TBO1" %>
...
function printDiv(divId) {
    ...
    <%--<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master"  CodeBehind="0386TBO1.aspx.vb" Inherits="Performance_Management_System._0386TBO1" %>--%><%--<%@ Page Language="vb" AutoEventWireup="false"  EnableEventValidation="false" MasterPageFile="~/Site1.Master"  CodeBehind="0386TBO1.aspx.vb" Inherits="Performance_Management_System._0386TBO1" %>--%>
</asp:Content>
                        ...
                        <td class="auto-style31" style="font-size: large; font-style: oblique; font-weight:bold">
                            <center>
                                <table class="nav-justified">
                                    <tr>
                                        <td class="auto-style114">Performance Review Form For Variable Pay (Only for level 3) Building OP 績效評核_可變薪酬評核表-僅適用於第三級作業職</td>
                                        </em>
                                        ...
                                        <table  class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                            ...
                                            <tr>
                                                ...
                                                <td class="auto-style122" colspan="3">Year : <em>
                                                    ...
                                                    <asp:CheckBox ID="Month" runat="server" CssClass="auto-style280" Text="Monthly" Checked="True" />
                                                    <em>&nbsp;</em><asp:CheckBox ID="q1" runat="server" CssClass="auto-style280" Text="Q1" AutoPostBack="True" Enabled="False" Visible="False" />
                                                    <em>&nbsp;</em><asp:CheckBox ID="q2" runat="server" CssClass="auto-style280" Text="Q2" AutoPostBack="True" Enabled="False" Visible="False" />
                                                    <em>&nbsp;</em><asp:CheckBox ID="q3" runat="server" CssClass="auto-style280" Text="Q3" AutoPostBack="True" Enabled="False" Visible="False" />
                                                    <em>&nbsp;</em><asp:CheckBox ID="q4" runat="server" CssClass="auto-style280" Text="Q4" AutoPostBack="True" Enabled="False" Visible="False" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <td class="auto-style280">
                            <table class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                                <tr style="background-color: #D9E1F2; text-align:center">
                                    ...
                                    <td class="auto-style132">16<strong>%</strong></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="auto-style130" rowspan="2">5<span class="auto-style289">. Environment 5S (環境5S) <em>
                                ...
                                <tr>
                                    <td class="auto-style320">Shift 班別 <em>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="score1" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </em></td>
                                </tr>
                                <tr>
                                    <td class="auto-style284" colspan="2" rowspan="2">
                                        <table  class=" auto-style326 nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                            <tr>
                                                <td class="auto-style325" rowspan="2">2.Scrap rate 報廢率</td>
                                                <td class="auto-style122">Semi-products 半成品<em><asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="score2" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                                    </em></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <td class="auto-style130" rowspan="4"><em>&nbsp;6. Near miss, accident, unsafe condition (nos) (未遂事件、事故、不安全狀況（否）)
                                    ...
                                    <td class="auto-style129" rowspan="4">
                                        <em>
                                        <table class="nav-justified">
                                            <tr>
                                ...
                                <tr>
                                    <td class="auto-style284" colspan="2">4. Defective rate 不良率</td>
                                    <td class="auto-style129"><em>
                                        <table class="nav-justified">
                                            <tr>
                    ...
                    <td class="auto-style280">
                        <table  class="nav-justified"  border ="1" style="width:100%; border-collapse: collapse; text-align:center">
                            <tr>
                                ...
                                <td class="auto-style314" style="background-color: #FFD966; text-align:center">8<strong>%</strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="ldr" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="11"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="shead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="12"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <em>
                                    <table class="nav-justified">
                            ...
                            <tr>
                                ...
                                <td class="auto-style138">
                                    <asp:TextBox ID="dhead" runat="server" CssClass="auto-style165" Width="244px" AutoPostBack="True" style="text-align:center" TabIndex="13"></asp:TextBox>
                                </td>
                                <td class="auto-style122">
                                    <asp:TextBox ID="score10" runat="server" CssClass="auto-style165" Width="244px" style="text-align:center" AutoPostBack="True" TabIndex="10"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                            ...
                            <table class="nav-justified"  border="1" style="width:100%; border-collapse: collapse; text-align:center;">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style122" colspan="4">
                                        &nbsp;<asp:TextBox ID="famnt" runat="server" AutoPostBack="True" CssClass="auto-style214" Height="24px" style="font-family: Calibri; text-align:center; font-size: small" Width="150px"></asp:TextBox>
                            ...
                            <table class="nav-justified" border="1"  style="width:100%; border-collapse: collapse; text-align:center">
                                ...
                                <tr>
                                    <td class="auto-style285">By Dept. Head
                                        ...
                                        部門經理</span><em></em></td>
                                    <td class="auto-style227">
                                        <asp:TextBox ID="remark4" runat="server" CssClass="auto-style214" Height="24px" style="font-family: Calibri; font-size: small" Width="150px" TextMode="MultiLine"></asp:TextBox>
                                    </td>
                                    <td class="auto-style209"><span class="auto-style289">
...
<label id="lblEmpDate" runat="server"></label>
    ...
    <div style="text-align: right;">A4/A3 No. 0399-1</div>
            ...
            <center>
                ...
                <span class="auto-style184"><%--<asp:Button ID="Button2" runat="server" CssClass="auto-style102" Height="43px" Text="Export To PDF" />--%>&nbsp;<asp:Button ID="update" runat="server" cssclass="btn btn-primary" style="font-family: call; font-size: small;" Text="Update" ValidationGroup="insert" OnClick="update_Click" />
